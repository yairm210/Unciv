...
## Triggerable uniques（Napapagana）
!!! note ""
...
??? example  "Remove [buildingFilter] [cityFilter]"
	/ Tanggalin [buildingFilter] [cityFilter]
...
??? example  "Sell [buildingFilter] buildings [cityFilter]"
	/ Ibenta ang mga gusaling [buildingFilter] sa [cityFilter]
...
??? example  "[positiveAmount] free [unit] units appear"
	/ [positiveAmount] libreng [unit] yunit ang lilitaw 
...
??? example  "Free Social Policy"
	/ Libreng Patakarang Panlipunan

	Applicable to: Triggerable

??? example  "[positiveAmount] Free Social Policies"
	/ [positiveAmount] Libreng Sosyal na Patakaran
...
??? example  "Empire enters golden age"
	/ Ang imperyo ay pumapasok sa Ginintuang Panahon

	Applicable to: Triggerable

??? example  "Empire enters a [positiveAmount]-turn Golden Age"
	/ Imperyo'y pumapasok sa isang [positiveAmount]-tirang Ginintuang Panahon
...
??? example  "Free Great Person"
	/ Libreng Dakilang Tao

	Applicable to: Triggerable

??? example  "[amount] population [cityFilter]"
	/ [amount] populasyon [cityFilter]
...
??? example  "[amount] population in a random city"
	/ [amount] population sa isang di-matukoy na lungsod
...
??? example  "[positiveAmount] Free Technologies"
	/ [positiveAmount] Libreng Teknolohiya
...
??? example  "[positiveAmount] free random researchable Tech(s) from the [eraFilter]"
	/ [positiveAmount] libreng di matukoy na pwedeng masaliksik na (mga) Teknolohiya mula sa [eraFilter]
...
??? example  "Reveals the entire map"
	/ Pinapakita ang buong mapa

	Applicable to: Triggerable

??? example  "Gain a free [beliefType] belief"
	/ Kumuha ng libreng [beliefType] na paniniwala
...
??? example  "Triggers voting for the Diplomatic Victory"
	/ Pinapagana ang pagboto para sa Diplomatikong Tagumpay
...
??? example  "Gain enough Faith for a Pantheon"
	/ Kumuha ng sapat na Pananalig para sa isang Panteon

	Applicable to: Triggerable

??? example  "Gain enough Faith for [positiveAmount]% of a Great Prophet"
	/ Kumuha ng sapat na Pananalig para sa [positiveAmount]% ng isang Dakilang Propeta
...
??? example  "Reveal up to [positiveAmount/'all'] [tileFilter] within a [positiveAmount] tile radius"
	/ Ipakita patungo sa [positiveAmount/'all'] [tileFilter] sa loob ng [positiveAmount] tile na layo
...
??? example  "Triggers the following global alert: [comment]"
	/ Nagdudulot ng abiso na ito : [comment]
...
??? example  "Provides the cheapest [stat] building in your first [positiveAmount] cities for free"
	/ Nagbibigay ng pinakamurang [stat] na gusali sa unang [positiveAmount] na lungsod nang libre. 
...
??? example  "Provides a [buildingName] in your first [positiveAmount] cities for free"
	/ Nagbibigay ng [buildingName] sa iyong unang [positiveAmount] lungsod nang libre
...
## UnitTriggerable uniques（PwedeMapaganaNgYunit）
!!! note ""
...
??? example  "[stats] from every specialist [cityFilter]"
	/ [stats] sa bawat espesyalista [cityFilter]
...
??? example  "[stats] per [positiveAmount] population [cityFilter]"
	/ [stats] kada [positiveAmount] populasyon [cityFilter]
...
??? example  "[stats] per [positiveAmount] social policies adopted"
	/ [stats] kada [positiveAmount] panlipunang patakaran na pinatupad
...
??? example  "[stats] per every [positiveAmount] [civWideStat]"
	/ [stats] kada mga [positiveAmount] [civWideStat]
...
??? example  "[stats] in cities on [terrainFilter] tiles"
	/ [stats] sa mga lungsod na nasa [terrainFilter]
...
??? example  "[stats] from all [buildingFilter] buildings"
	/ [stats] mula sa lahat ng [buildingFilter] na gusali
...
??? example  "[stats] from [tileFilter] tiles [cityFilter]"
	/ [stats] mula sa [tileFilter] tiles [cityFilter]
...
??? example  "[stats] from each Trade Route"
	/ [stats] sa bawat Rutang Pangkalakal
...
??? example  "[relativeAmount]% [stat] from City-States"
	/ [relativeAmount]% [stat] mula sa mga Lungsod-Estado
...
??? example  "[relativeAmount]% [stat] from Trade Routes"
	/ [relativeAmount]% [stat] mula sa mga Ruta ng Kalakal 
...
??? example  "Nullifies [stat] [cityFilter]"
	/ Nagpapawalang-bisa ng [stat] [cityFilter] 
...
??? example  "Nullifies Growth [cityFilter]"
	/ Nagpapawalang-bisa ng Paglaki [cityFilter]
...
??? example  "[relativeAmount]% Production when constructing [buildingFilter] buildings [cityFilter]"
	/ [relativeAmount]% Produksyon tuwing magtatayo ng [buildingFilter] na gusali [cityFilter]
...
??? example  "[relativeAmount]% Production when constructing [baseUnitFilter] units [cityFilter]"
	/ [relativeAmount]% Produksyon kapag gumagawa ng [baseUnitFilter] na yunit [cityFilter] 
...
??? example  "[relativeAmount]% Production when constructing [buildingFilter] wonders [cityFilter]"
	/ [relativeAmount]% Produksyon kapag nagtatayo ng [buildingFilter] kamanghaan [cityFilter]
...
??? example  "[relativeAmount]% Production towards any buildings that already exist in the Capital"
	/ [relativeAmount]% Produkyson patungo sa mga gusaling itinayo na sa Kabisera
...
??? example  "Military Units gifted from City-States start with [positiveAmount] XP"
	/ Nagsisimula sa [positiveAmount] XP ang mga regalong yunit-militar mula sa mga Lungsod-Estado
...
??? example  "Militaristic City-States grant units [positiveAmount] times as fast when you are at war with a common nation"
	/ Militaristikong Lungsod-Estado ay magbibigay ng yunit na [positiveAmount] bases na mas mabilis kapag kayo'y may parehong kaaway na nasyon
...
??? example  "Gifts of Gold to City-States generate [relativeAmount]% more Influence"
	/ Regalong ginto sa mga Lungsod-Estado ay magbibigay ng [relativeAmount]% mas maraming Impluwensya
...
??? example  "City-State territory always counts as friendly territory"
	/ Palaging tinatrato bilang teritoryo ng kaibigan ang teritoryo ng Lungsod-Estado

	Applicable to: Global

??? example  "Allied City-States will occasionally gift Great People"
	/ Mga kaalyado na Lungsod-Estado ay paminsan-minsan na magreregalo ng Dakilang Tao 

	Applicable to: Global

??? example  "[relativeAmount]% City-State Influence degradation"
	/ [relativeAmount]% pagbaba ng Impluwensya sa Lungsod-Estado
...
??? example  "Resting point for Influence with City-States is increased by [amount]"
	/ Batayang punto ng Impluwensya sa mga Lungsod-Estado ay itataas ng [amount] na puntos
...
??? example  "Allied City-States provide [stat] equal to [relativeAmount]% of what they produce for themselves"
	/ Kaalyadong Lungsod-Estado ay magbibigay ng [stat] katumbas ng [relativeAmount]% na ginagawa nila para sa kanilang sarili
...
??? example  "[relativeAmount]% resources gifted by City-States"
	/ [relativeAmount]% na pagkukunan ay ireregalo ng mga Lungsod-Estado
...
??? example  "[relativeAmount]% Happiness from luxury resources gifted by City-States"
	/ [relativeAmount]% Kasiyahan mula sa karangyaan ay ireregalo ng mga Lungsod-Estado
...
??? example  "City-State Influence recovers at twice the normal rate"
	/ Bumubuti ang Impluwensya sa Lungsod-Estado ng doble sa normal na bilis 

	Applicable to: Global

??? example  "[relativeAmount]% growth [cityFilter]"
	/ [relativeAmount]% paglaki [cityFilter]
...
??? example  "[amount]% Food is carried over after population increases [cityFilter]"
	/ pinapasa ang [amount]% Pagkain pagkatapos na lumaki ang populasyon [cityFilter]
...
??? example  "[relativeAmount]% unhappiness from the number of cities"
	/ [relativeAmount]% na kalungkutan mula sa mga bilang na mga siyudad
...
??? example  "[relativeAmount]% Unhappiness from [populationFilter] [cityFilter]"
	/ [relativeAmount]% Kalungkutan mula sa [populationFilter] [cityFilter]
...
??? example  "[amount] Happiness from each type of luxury resource"
	/ [amount] Kaligayahan mula sa bawat uri ng karangyaan
...
??? example  "Retain [relativeAmount]% of the happiness from a luxury after the last copy has been traded away"
	/ Panatilihin ang [relativeAmount]% ng kasiyahan mula sa isang karangyaan pagkatapos ito ibenta
...
??? example  "[relativeAmount]% of excess happiness converted to [stat]"
	/ [relativeAmount]% ng sobrang happiness ay magiging [stat]
...
??? example  "Cannot build [baseUnitFilter] units"
	/ Hindi kayang gumawa ng mga [baseUnitFilter] na yunit
...
??? example  "Enables construction of Spaceship parts"
	/ Pinapagana ang paggawa ng parte ng Sasakyang PangKalawakan

	Applicable to: Global

??? example  "May buy [baseUnitFilter] units for [nonNegativeAmount] [stat] [cityFilter] at an increasing price ([amount])"
	/ Maaaring bumili ng [baseUnitFilter] na yunit sa halagang [amount] [stat] [cityFilter] at may presyong patong na ([nonNegativeAmount])
...
??? example  "May buy [buildingFilter] buildings for [nonNegativeAmount] [stat] [cityFilter] at an increasing price ([amount])"
	/ Maaring bumili ng mga [buildingFilter]  na gusali para sa [amount] [stat] [cityFilter] sa isang tumataas na ([nonNegativeAmount]) presyo
...
??? example  "May buy [baseUnitFilter] units for [nonNegativeAmount] [stat] [cityFilter]"
	/ Maaring bumili ng mga [baseUnitFilter] na yunit para sa [nonNegativeAmount] [stat] [cityFilter]
...
??? example  "May buy [buildingFilter] buildings for [nonNegativeAmount] [stat] [cityFilter]"
	/ Pwedeng bumili ng gusaling [buildingFilter] sa halagang [nonNegativeAmount] [stat] [cityFilter]
...
??? example  "May buy [baseUnitFilter] units with [stat] [cityFilter]"
	/ Maaring bumili ng mga [baseUnitFilter] na yunit gamit ng [stat] [cityFilter]
...
??? example  "May buy [buildingFilter] buildings with [stat] [cityFilter]"
	/ Pwedeng bumili ng gusaling [buildingFilter] gamit ng [stat] [cityFilter]
...
??? example  "May buy [baseUnitFilter] units with [stat] for [nonNegativeAmount] times their normal Production cost"
	/ Maaaring bumili ng [baseUnitFilter] na mga yunit gamit ang [stat] sa halagang [nonNegativeAmount] beses na higit sa normal na halaga ng Produksyon
...
??? example  "May buy [buildingFilter] buildings with [stat] for [nonNegativeAmount] times their normal Production cost"
	/ Maaring bumili ng mga [buildingFilter] na gusali ng [stat] para sa [nonNegativeAmount] beses na higit sa normal na gastos sa Produksyon
...
??? example  "[stat] cost of purchasing items in cities [relativeAmount]%"
	/ [stat] gastos sa pagbili sa loob ng mga lungsod [relativeAmount]%
...
??? example  "[stat] cost of purchasing [buildingFilter] buildings [relativeAmount]%"
	/ [stat] gastos sa pagbili ng [buildingFilter] na gusali [relativeAmount]%
...
??? example  "[stat] cost of purchasing [baseUnitFilter] units [relativeAmount]%"
	/ [stat] gastos ng pagbili ng [baseUnitFilter] na yunit [relativeAmount]%
...
??? example  "Enables conversion of city production to [civWideStat]"
	/ Pinapagana ang paglilipat ng produksyon ng lungsod sa [civWideStat]
...
??? example  "Improves movement speed on roads"
	/ Pinagbubuti ang bilis ng paggalaw sa daan

	Applicable to: Global

??? example  "Roads connect tiles across rivers"
	/ Ang mga daan ay nakadugtong sa pagitan ng mga ilog

	Applicable to: Global

??? example  "[relativeAmount]% maintenance on road & railroads"
	/ [relativeAmount]% pagpapanatili ng mga kalsada at riles ng tren
...
??? example  "No Maintenance costs for improvements in [tileFilter] tiles"
	/ Walang gastos sa pagpapanatili ng mga pagbubuti sa [tileFilter] na tile
...
??? example  "[relativeAmount]% construction time for [improvementFilter] improvements"
	/ [relativeAmount]% oras sa paggawa para sa pagbubuti ng mga [improvementFilter]
...
??? example  "[relativeAmount]% Culture cost of natural border growth [cityFilter]"
	/ [relativeAmount]% gastos sa Kultura ng likas na paglawak ng teritoryo [cityFilter] 
...
??? example  "[relativeAmount]% Gold cost of acquiring tiles [cityFilter]"
	/ [relativeAmount]% gastos sa Ginto ng pagkuha ng bagong tiles [cityFilter] 
...
??? example  "Each city founded increases culture cost of policies [relativeAmount]% less than normal"
	/ Mababawasan ng [relativeAmount]% sa normal na gastos sa kultura sa bawat tinatag na lungsod 
...
??? example  "[relativeAmount]% Culture cost of adopting new Policies"
	/ [relativeAmount]% gastos sa Kultura sa bawat bagong pinagtibay na Patakaran
...
??? example  "[stats] for every known Natural Wonder"
	/ [stats] sa kada kilalang Likas Yaman 
...
??? example  "[relativeAmount]% Great Person generation [cityFilter]"
	/ [relativeAmount]% paggawa ng Dakilang Tao [cityFilter]
...
??? example  "[relativeAmount]% Gold from Great Merchant trade missions"
	/ [relativeAmount]% Ginto mula sa mga misyong pangkalakal ng mga Dakilang Negosyante
...
??? example  "Great General provides double combat bonus"
	/ Ang Dakilang Heneral ay nagbibigay ng doble na karadagdagang kalamangan sa labanan
...
??? example  "Receive a free Great Person at the end of every [comment] (every 394 years), after researching [tech]. Each bonus person can only be chosen once."
	/ Tumanggap ng isang libreng Dakilang Tao sa katapusan ng bawat [comment] (kada 394 na taon), pagkatapos masaliksik ang [tech]. Kada ekstrang dakilang tao ay maaaring pillin lamang ng isang beses.
...
??? example  "Once The Long Count activates, the year on the world screen displays as the traditional Mayan Long Count."
	/ Kapag gumana ang Mahabang Bilang, ang taon sa nakapaskil sa screen ng mundo ay ang tradisyunal na Mahabang Bilang ng mga Mayan.

	Applicable to: Global

??? example  "[amount] Unit Supply"
	/ [amount] Suplay ng Yunit
...
??? example  "[amount] Unit Supply per [positiveAmount] population [cityFilter]"
	/ [amount] Suplay ng Yunit bawat [positiveAmount] population [cityFilter]
...
??? example  "[amount] Unit Supply per city"
	/ [amount] Suplay ng Yunit kada lungsod
...
??? example  "[amount] units cost no maintenance"
	/ [amount] na yunit ay walang gastos sa pagpapanatili
...
??? example  "Units in cities cost no Maintenance"
	/ Mga yunit sa loob ng lungsod ay walang binabayaran sa pagpapanatili. 

	Applicable to: Global

??? example  "Enables embarkation for land units"
	/ Pinapagana ang pagsakay sa barko para sa mga yunit ng lupa
...
??? example  "Enables [mapUnitFilter] units to enter ocean tiles"
	/ Pinapagana ang mga [mapUnitFilter] na yunit na pumasok sa mga karagatan na tile
...
??? example  "Land units may cross [terrainName] tiles after the first [baseUnitFilter] is earned"
	/ Maaaring lumakbay ang mga yunit sa lupa sa mga [terrainName] na tile pagkatapos kunin ang unang [baseUnitFilter]
...
??? example  "Enemy [mapUnitFilter] units must spend [positiveAmount] extra movement points when inside your territory"
	/ Mga kalaban na [mapUnitFilter] yunit ay kailangang magbayad ng [positiveAmount] karagdagang puntos sa paggalaw kapag nasa loob ng iyong nasasakupan
...
??? example  "All newly-trained [baseUnitFilter] units [cityFilter] receive the [promotion] promotion"
	/ Lahat ng bagong sanay na [baseUnitFilter] yunit [cityFilter] ay makakatanggap ng [promotion] promosyon.
...
??? example  "[mapUnitFilter] Units adjacent to this city heal [amount] HP per turn when healing"
	/ [mapUnitFilter] na mga yunit na katabi ng lungsod na ito ay tatanggap ng [amount] HP kada tira kapag nagpapagaling
...
??? example  "[relativeAmount]% City Strength from defensive buildings"
	/ [relativeAmount]% Lakas ng Lungsod mula sa mga pangdepensa na gusali
...
??? example  "[relativeAmount]% Strength for cities"
	/ [relativeAmount]% Lakas para sa mga lungsod
...
??? example  "Enables Open Borders agreements"
	/ Pinapagana ang kasunduan sa Bukas na mga Hangganan

	Applicable to: Global

??? example  "Enables Research agreements"
	/ Pinapagana ang Kasunduan sa Pananaliksik

	Applicable to: Global

??? example  "Science gained from research agreements [relativeAmount]%"
	/ Siyensyang makukuha mula sa mga kasunduan ng pagsaliksik [relativeAmount]%
...
??? example  "Enables Defensive Pacts"
	/ Paganahin ang mga Kasunduang Pang-depensa

	Applicable to: Global

??? example  "When declaring friendship, both parties gain a [relativeAmount]% boost to great person generation"
	/ Sa deklarasyon ng pagkakaibigan, tatanggap ang dalawang partido ng [relativeAmount]% dagdag sa paglikha ng dakilang tao
...
??? example  "Influence of all other civilizations with all city-states degrades [relativeAmount]% faster"
	/ Impluwensya ng ibang sibilisasyon sa lahat ng Lungsod-Estado ay tutumbasan ng [relativeAmount]% na higit na pagbababa 
...
??? example  "Gain [amount] Influence with a [baseUnitFilter] gift to a City-State"
	/ Tumanggap ng [amount] Impluwensya mula sa isang [baseUnitFilter] na regalo sa isang Lungsod-Estado
...
??? example  "Resting point for Influence with City-States following this religion [amount]"
	/ Basehang punto para sa Impluwensya ng mga Lungsod-Estado na tagasunod ng relihiyon ay [amount]
...
??? example  "Notified of new Barbarian encampments"
	/ Makakatanggap ng abiso sa mga bagong kuta ng mga Salbahe
...
??? example  "When conquering an encampment, earn [amount] Gold and recruit a Barbarian unit"
	/ Tuwing sinasakop ang kampo, kumuha ng [amount] na Ginto at kumalap ng isang Salbahe na yunit
...
??? example  "When defeating a [mapUnitFilter] unit, earn [amount] Gold and recruit it"
	/ Kapag matatalo ang [mapUnitFilter] na yunit, kumuha ng [amount] Gold at kalapin ito
...
??? example  "May choose [amount] additional [beliefType] beliefs when [foundingOrEnhancing] a religion"
	/ Maaring pumili ng [amount] karagdagang mga [beliefType] paniniwala kapag [foundingOrEnhancing] ng isang relihiyon
...
??? example  "May choose [amount] additional belief(s) of any type when [foundingOrEnhancing] a religion"
	/ Maaaring pumili ng [amount] dagdag na (mga) paniniwala kahit anong anyo tuwing [foundingOrEnhancing] ng relihiyon
...
??? example  "[stats] when a city adopts this religion for the first time"
	/ [stats] tuwing magpatibay ng relihiyon ang lungsod sa unang pagkakataon 
...
??? example  "[relativeAmount]% Natural religion spread [cityFilter]"
	/ [relativeAmount]% Natural na pagkalat ng relihiyon [cityFilter]
...
??? example  "Religion naturally spreads to cities [amount] tiles away"
	/ natural na kumakalat ang relihiyon sa mga lungsod [amount] mga tile na layo
...
??? example  "May not generate great prophet equivalents naturally"
	/ Hindi maaaring gumawa ng mga natural na pamalit sa mga dakilang propeta

	Applicable to: Global

??? example  "[relativeAmount]% Faith cost of generating Great Prophet equivalents"
	/ [relativeAmount]% gastos sa Paniniwala mula sa pagkuha ng Dakilang Propeta at mga katulad nito
...
??? example  "[relativeAmount]% spy effectiveness [cityFilter]"
	/ [relativeAmount]% na epektibo ang espiya [cityFilter]
...
??? example  "[relativeAmount]% enemy spy effectiveness [cityFilter]"
	/ [relativeAmount]% na epektibo ang kalabang espiya [cityFilter]
...
??? example  "Triggers victory"
	/ Nagpapagana ng tagumpay

	Applicable to: Global

??? example  "Triggers a Cultural Victory upon completion"
	/ Nag-trigger ng Kultural na Tagumpay kapag natapos na

	Applicable to: Global

??? example  "May buy items in puppet cities"
	/ Pwedeng bumili ng mga bagay sa mga papet na siyudad
...
??? example  ""Borrows" city names from other civilizations in the game"
	/ "Humihiram" ng mga pangalan ng lungsod sa ibang sibilisasyon sa laro

	Applicable to: Global

??? example  "Cities are razed [amount] times as fast"
	/ Mga lungsod ay winawasak nang [amount] na beses na bilis
...
??? example  "Receive a tech boost when scientific buildings/wonders are built in capital"
	/ Tumanggap ng pagbilis sa pagdiskubre ng teknolohiya kapag itayo ang mga siyentipiko na gusali/kamanghaan sa loob ng kabisera

	Applicable to: Global

??? example  "[relativeAmount]% Golden Age length"
	/ [relativeAmount]% haba ng Ginintuang Panahon
...
??? example  "Population loss from nuclear attacks [relativeAmount]% [cityFilter]"
	/ Kawalan ng populasyon sa mga sa-ubod na pag-atake [relativeAmount]% [cityFilter]
...
??? example  "Rebel units may spawn"
	/ Maaaring magpakita ang mga rebeldeng yunit
...
??? example  "[relativeAmount]% Strength decreasing with distance from the capital"
	/ [relativeAmount]% bumababa ang Lakas sa layo mula sa kabisera
...
??? example  "[relativeAmount]% to Flank Attack bonuses"
	/ [relativeAmount]% dagdag sa mga Atake sa Gilid
...
??? example  "[amount] additional attacks per turn"
	/ [amount] dagdag na atake kada tira 
...
??? example  "[relativeAmount]% Spread Religion Strength"
	/ [relativeAmount]% Lakas ng Pagkalat ng Relihiyon
...
??? example  "When spreading religion to a city, gain [amount] times the amount of followers of other religions as [stat]"
	/ Tuwing nagpapalaganap ng relihiyon sa isang lungsod, kumuha ng [amount] beses na higit sa numero ng mga tagasunod ng mga ibang relihiyon bilang [stat]
...
??? example  "Ranged attacks may be performed over obstacles"
	/ Mga pangmalayo na atake ay pwedeng lampas sa mga hadlang

	Applicable to: Global, Unit

??? example  "No defensive terrain bonus"
	/ Walang dagdag na depensa sa lupain

	Applicable to: Global, Unit

??? example  "No defensive terrain penalty"
	/ Walang parusa sa depensa na kaugnay ng lupain
...
??? example  "Unable to capture cities"
	/ Di-kayang mag-angkin ng mga lungsod
...
??? example  "No movement cost to pillage"
	/ Walang gastos sa paggalaw tuwing nagnanakaw

	Applicable to: Global, Unit

??? example  "May heal outside of friendly territory"
	/ Maaaring gumaling sa labas ng teritoryo ng kaibigan

	Applicable to: Global, Unit

??? example  "All healing effects doubled"
	/ Doble ang lahat ng mga pagpapagaling na epekto

	Applicable to: Global, Unit

??? example  "Heals [amount] damage if it kills a unit"
	/ Gumaling ng [amount] na pinsala kapag ito'y makapatay ng isang yunit
...
??? example  "Can only heal by pillaging"
	/ Nagpapagaling lamang sa pagnanakaw

	Applicable to: Global, Unit

??? example  "[relativeAmount]% maintenance costs"
	/ [relativeAmount]% gastos sa pagpapanatili
...
??? example  "[relativeAmount]% Gold cost of upgrading"
	/ [relativeAmount]% gastos sa Ginto sa pagtataas ng mga yunit
...
??? example  "Earn [amount]% of the damage done to [combatantFilter] units as [stockpile]"
	/ Kumuha ng [amount]% ng ginawang pinsala sa mga [combatantFilter] na yunit bilang [stockpile]
...
??? example  "Upon capturing a city, receive [amount] times its [stat] production as [stockpile] immediately"
	/ Kapag sumakop ng isang lungsod, tumanggap ng [amount] na beses sa produksyon ng [stat] bilang [stockpile] kaagad
...
??? example  "Earn [amount]% of killed [mapUnitFilter] unit's [costOrStrength] as [stockpile]"
	/ Kumuha ng [amount]% na [costOrStrength] sa mga napatay na [mapUnitFilter] yunit bilang [stockpile]
...
??? example  "[amount] XP gained from combat"
	/ [amount] XP malilikom sa pakikidigma
...
??? example  "[relativeAmount]% XP gained from combat"
	/ [relativeAmount]% XP mula sa labanan
...
??? example  "[greatPerson] is earned [relativeAmount]% faster"
	/ [greatPerson] ay makukuha mo ng [relativeAmount]% na mas mabilis 
...
??? example  "[nonNegativeAmount] Movement point cost to disembark"
	/ [nonNegativeAmount] gastos sa Paggalaw upang makaalis sa sinasakyang bangka
...
??? example  "[nonNegativeAmount] Movement point cost to embark"
	/ [nonNegativeAmount] gastos sa Pagkilos na puntos para sumakay ng barko
...
## Nation uniques（Nasyon）
??? example  "Starts with [tech]"
	/ Nagsisimula kasama ang [tech]
...
??? example  "Starts with [policy] adopted"
	/ Nagsisimula sa pagtibay ng [policy]
...
??? example  "All units move through Forest and Jungle Tiles in friendly territory as if they have roads. These tiles can be used to establish City Connections upon researching the Wheel."
	/ Lahat ng unit na gumagalaw sa Kakahuyan at Kagubatan na tiles sa teritoryo ng kaibigan ay parang may mga kalsada sila. Maaaring gamitin ang mga tile na ito upang magtatag ng Mga Koneksyon sa Lungsod sa pagsasaliksik sa Gulong.
...
??? example  "Units ignore terrain costs when moving into any tile with Hills"
	/ Di-pinapansin ng mga yunit ang mga gastos ng kalupaan tuwing gumagalaw sa mga burol 
...
??? example  "Will not be chosen for new games"
	/ Hindi mapipili sa mga bagong laro
...
??? example  "Starting in this era disables religion"
	/ Hindi pinapagana ang relihiyon kapag nagsimula sa panahong ito

	Applicable to: Era

??? example  "Every major Civilization gains a spy once a civilization enters this era"
	/ Bawat malaking sibilisasyon ay kukuha ng isang espiya kapag ito'y pumasok sa panahong ito

	Applicable to: Era

## Tech uniques（Teknolohiya）
??? example  "Starting tech"
	/ Panimulang teknolohiya

	Applicable to: Tech

??? example  "Can be continually researched"
	/ Maaaring patuloy na pagsasaliksik
...
## FounderBelief uniques（TagapagtatagNaPaniniwala）
!!! note ""
...
??? example  "[stats] for each global city following this religion"
	/ [stats] sa bawat lungsod sa daigdig na sumsunod sa relihiyon
...
??? example  "[stats] from every [positiveAmount] global followers [cityFilter]"
	/ [stats] mula sa bawat [positiveAmount] tagasunod sa daigdig [cityFilter]
...
## FollowerBelief uniques（TagasunodNaPaniniwala）
!!! note ""
...
??? example  "Earn [amount]% of [mapUnitFilter] unit's [costOrStrength] as [stockpile] when killed within 4 tiles of a city following this religion"
	/ Kumuha ng [amount]% ng [mapUnitFilter] mula sa isang yunit na [costOrStrength] bilang [stockpile] kapag pinaslang sa loob ng 4 na tile mula sa isang lungsod na naniniwala sa relihiyong ito
...
??? example  "Can be purchased with [stat] [cityFilter]"
	/ Maaaring mabili ng [stat] [cityFilter]
...
??? example  "Can be purchased for [amount] [stat] [cityFilter]"
	/ Maaring mabili para sa [amount] [stat] [cityFilter]
...
??? example  "Limited to [amount] per Civilization"
	/ Limitado sa [amount] bawat sibilisasyon
...
??? example  "Excess Food converted to Production when under construction"
	/ Sobrang Pagkain ay ginagawang Produksyon kapag ito'y nasa konstruksyon

	Applicable to: Building, Unit

??? example  "Requires at least [amount] population"
	/ Kinakailangan na hindi bababa sa [amount] na populasyon
...
??? example  "Triggers a global alert upon build start"
	/ Nagti-trigger ng pandaigdigang abiso sa pagsisimula ng pagtayo

	Applicable to: Building, Unit

??? example  "Triggers a global alert upon completion"
	/ Nagti-trigger ng pandaigdigang alerto kapag nakumpleto

	Applicable to: Building, Unit

??? example  "Cost increases by [amount] per owned city"
	/ Ang gastos ay lumalaki ng [amount] bawat lungsod na pag-aari
...
??? example  "Cost increases by [amount] when built"
	/ Madadagdagan ang gastos nang [amount] kapag naipatayo
...
??? example  "Must have an owned [tileFilter] within [amount] tiles"
	/ Dapat may pag-aari ng [tileFilter] sa loob ng [amount] tiles 
...
??? example  "Enables nuclear weapon"
	/ Pinapagana ang sandatang nuklear
...
??? example  "Must not be next to [tileFilter]"
	/ Hindi dapat katabi ng [tileFilter]
...
??? example  "Indicates the capital city"
	/ Nagpapahiwatig ng kabiserang lungsod

	Applicable to: Building

??? example  "Moves to new capital when capital changes"
	/ Ilipat ang bagong kabisera kapag ang kabisera ay nagbago

	Applicable to: Building

??? example  "Provides 1 extra copy of each improved luxury resource near this City"
	/ Nagbibigay ng 1 karagdagang kopya ng bawat pinahusay na marangyang mapagkukunan malapit sa Lungsod na ito

	Applicable to: Building

??? example  "Destroyed when the city is captured"
	/ Mawawasak kapag makuha ang lungsod ng kaaway

	Applicable to: Building

??? example  "Never destroyed when the city is captured"
	/ Hindi mawawasak kapag ang lungsod ay nakuha ng iba
...
??? example  "Connects trade routes over water"
	/ Nagdudugtong ng mga ruta ng kalakal sa tubig

	Applicable to: Building

??? example  "Automatically built in all cities where it is buildable"
	/ Kusang gumawa sa lahat ng siyudad na pwede itong tayuan

	Applicable to: Building

??? example  "Creates a [improvementName] improvement on a specific tile"
	/ Gumagawa ng [improvementName] na pagbubuti sa isang tiyak na tile
...
??? example  "Can carry [amount] extra [mapUnitFilter] units"
	/ Maaaring magdala ng karagdagang [amount] [mapUnitFilter] na yunit
...
??? example  "Spaceship part"
	/ Bahagi ng Sasakyang-Pangkalawakan
...
??? example  "Can instantly construct a [improvementFilter] improvement"
	/ Kayang gumawa kaagad ng isang pagbubuti na [improvementFilter] 
...
??? example  "Can Spread Religion"
	/ Maaaring Magpalaganap ng Relihiyon

	Applicable to: UnitAction

??? example  "Can remove other religions from cities"
	/ Maaaring tagalin ang ibang mga relihiyon sa mga siyudad

	Applicable to: UnitAction

??? example  "May found a religion"
	/ Maaaring magtatag ng isang relihiyon

	Applicable to: UnitAction

??? example  "May enhance a religion"
	/ Maaaring magpabuti ng isang relihiyon

	Applicable to: UnitAction

??? example  "Can transform to [unit]"
	/ Maaaring magbago ang anyo sa [unit]
...
??? example  "May create improvements on water resources"
	/ Maaaring lumikha ng mga pagbubuti sa mga pagkukunan na nasa tubig

	Applicable to: Unit

??? example  "Can build [improvementFilter/terrainFilter] improvements on tiles"
	/ Maaaring magtayo ng [improvementFilter/terrainFilter] na pagbubuti sa mga tiles
...
??? example  "Can be added to [comment] in the Capital"
	/ Kayang idagdag sa [comment] na nasa loob ng Kabisera 
...
??? example  "Prevents spreading of religion to the city it is next to"
	/ Pinipigilan ang pagkalat ng relihiyn sa lungsod na katabi nito

	Applicable to: Unit

??? example  "Removes other religions when spreading religion"
	/ Nagtatanggal ng ibang relihiyon tuwing nagpapalaganap ng relihiyon
...
??? example  "Can perform Air Sweep"
	/ Kayang gumawa ng Air Sweep

	Applicable to: Unit

??? example  "Can speed up construction of a building"
	/ Kayang bilisan ang pagtatayo ng isang gusali

	Applicable to: Unit

??? example  "Can speed up the construction of a wonder"
	/ Maaring magpabilis ng isang kamanghaan

	Applicable to: Unit

??? example  "Can hurry technology research"
	/ Kayang madaliin ang pagsasaliksik ng teknolohiya

	Applicable to: Unit

??? example  "Can generate a large amount of culture"
	/ Maaaring makagawa ng malaking bilang na kultura

	Applicable to: Unit

??? example  "Can undertake a trade mission with City-State, giving a large sum of gold and [amount] Influence"
	/ Kayang gumawa ng misyong kalakal sa isang Lungsod-Estado, at nagbibigay ng malaking kabuuan ng ginto at [amount] na impluwensya
...
??? example  "[relativeAmount]% Strength for enemy [mapUnitFilter] units in adjacent [tileFilter] tiles"
	/ [relativeAmount]% Lakas para sa mga yunit ng kaaway [mapUnitFilter] sa katabing [tileFilter] na mga tile
...
??? example  "[relativeAmount]% Strength bonus for [mapUnitFilter] units within [amount] tiles"
	/ [relativeAmount]% bonus na Lakas para sa [mapUnitFilter] na mga yunit na nasa [amount] tile na layo
...
??? example  "Can only attack [combatantFilter] units"
	/ Maaaring lamang umaatake sa mga [combatantFilter] na yunit
...
??? example  "Can only attack [tileFilter] tiles"
	/ Maaaring umatake lang sa [tileFilter] na mga tile
...
??? example  "Must set up to ranged attack"
	/ Kailangang ayusin muna bago umatake nang malayo

	Applicable to: Unit

??? example  "Self-destructs when attacking"
	/ Winawasak ang sarili kapag umaatake

	Applicable to: Unit

??? example  "Eliminates combat penalty for attacking across a coast"
	/ Tinatanggal ang parusa ng pag-atake sa baybayin

	Applicable to: Unit

??? example  "May attack when embarked"
	/ Maaaring umatake kapag nakasakay sa barko

	Applicable to: Unit

??? example  "Eliminates combat penalty for attacking over a river"
	/ Tinatanggal ang parusa ng pag-atake sa ilog

	Applicable to: Unit

??? example  "Blast radius [amount]"
	/ Lawak ng pagsabog [amount]
...
??? example  "Nuclear weapon of Strength [amount]"
	/ Sa-ubod na sandata ng may Lakas na [amount]
...
??? example  "Can move after attacking"
	/ Maaaring gumalaw pagkatapos na umatake

	Applicable to: Unit

??? example  "Transfer Movement to [mapUnitFilter]"
	/ Ibigay ang Paggalaw sa [mapUnitFilter]
...
??? example  "Can move immediately once bought"
	/ Maaaring kumilos agad kapag naibili
...
??? example  "Unit will heal every turn, even if it performs an action"
	/ Gumagaling ang yunit kada tira, kahit may ginagawa ito

	Applicable to: Unit

??? example  "All adjacent units heal [amount] HP when healing"
	/ Lahat ng katabi na yunit ay gumagaling ng [amount] HP
...
??? example  "Can see over obstacles"
	/ Maaaring makakita lampas sa mga hadlang

	Applicable to: Unit

??? example  "Can carry [amount] [mapUnitFilter] units"
	/ kayang magdala ng [amount] [mapUnitFilter] na yunit
...
??? example  "Cannot be carried by [mapUnitFilter] units"
	/ Hindi kayang dalhin ng mga [mapUnitFilter] na yunit
...
??? example  "[relativeAmount]% chance to intercept air attacks"
	/ [relativeAmount]% pagkakataon na puksain ang mga atake sa ere
...
??? example  "Damage taken from interception reduced by [relativeAmount]%"
	/ Pinsalang dulot ng pagtagpo ay nababawasan ng [relativeAmount]%
...
??? example  "[relativeAmount]% Damage when intercepting"
	/ [relativeAmount]% Pinsala kapag nagtatagpo
...
??? example  "[amount] extra interceptions may be made per turn"
	/ [amount] dagdag na pagtagpo ang pwedeng gawin kada tira 
...
??? example  "[relativeAmount]% Strength when performing Air Sweep"
	/ [relativeAmount]% Lakas kapag gumagawa ng Air Sweep
...
??? example  "May capture killed [mapUnitFilter] units"
	/ Maaaring dumakip ng pinaslang na [mapUnitFilter] yunit
...
??? example  "Invisible to others"
	/ Hindi makikita ng iba

	Applicable to: Unit

??? example  "Invisible to non-adjacent units"
	/ Hindi nakikita ng mga katabi na yunit

	Applicable to: Unit

??? example  "Can see invisible [mapUnitFilter] units"
	/ Maaaring makakita ng [mapUnitFilter] units
...
??? example  "May upgrade to [unit] through ruins-like effects"
	/ Maaaring itaas sa [unit] sa pamamagitan ng mga epekto na tulad sa guho
...
??? example  "Can upgrade to [unit]"
	/ Maaaring i-upgrade hanggang [unit]
...
??? example  "Destroys tile improvements when attacking"
	/ Winawasak ang mga pagbubuti sa tile kapag umaatake 
...
??? example  "Double movement in [terrainFilter]"
	/ Dobleng paggalaw sa [terrainFilter]
...
??? example  "All tiles cost 1 movement"
	/ Lahat ng tile ay may gastos na 1 paggalaw
...
??? example  "May travel on Water tiles without embarking"
	/ Pwedeng maglakbay sa Tubig na tile nang hindi sumasampa
...
??? example  "Can pass through impassable tiles"
	/ Pwedeng dumaan sa mga di madaanan na tiles
...
??? example  "Ignores terrain cost"
	/ Hindi pinapansin ang gastos sa lupain
...
??? example  "Ignores Zone of Control"
	/ Walang pake sa Sona ng Kontrol
...
??? example  "Rough terrain penalty"
	/ May parusa sa mga magaspang na lupain
...
??? example  "Can enter ice tiles"
	/ Maaaring pumasok sa yelong tiles
...
??? example  "Cannot enter ocean tiles"
	/ Hindi makakapasok sa mga karagatan na mga tiles

	Applicable to: Unit

??? example  "May enter foreign tiles without open borders"
	/ Maaaring pumasok sa mga dayuhang tile nang walang bukas na hangganan
...
??? example  "May enter foreign tiles without open borders, but loses [amount] religious strength each turn it ends there"
	/ Maaaring pumasok ng dayuhang lupa ng walang malayang hangganan, ngunit nababawasan ng [amount] na relihiyosong lakas kada tira na nagtatapos ito doon
...
??? example  "Takes your religion over the one in their birth city"
	/ Kinukuha ang iyong relihiyon mula sa isang nasa kanilang pinanggalingang lungsod

	Applicable to: Unit

??? example  "Great Person - [comment]"
	/ Dakilang Tao - [comment]
...
??? example  "Doing so will consume this opportunity to choose a Promotion"
	/ Kapag ginawa ito, mawawala ang pagkakataon na makapili ng promosyon
...
??? example  "Units ending their turn on this terrain take [amount] damage"
	/ Ang mga unit na nagtatapos sa kanilang tira sa lupain na ito ay tatanggap ng [amount] ng pinsala
...
??? example  "Grants [promotion] ([comment]) to adjacent [mapUnitFilter] units for the rest of the game"
	/ Nagbibigay ng [promotion] ([comment]) sa katabi na [mapUnitFilter] yunit para sa buong laro.
...
??? example  "[amount] Strength for cities built on this terrain"
	/ [amount] Lakas para sa mga lungsod na nakatayo sa lupain na ito
...
??? example  "Tile provides yield without assigned population"
	/ Nagbibigay ng ani ang Tile na hindi kailangan ang nakatalagang populasyon

	Applicable to: Terrain, Improvement

??? example  "Nullifies all other stats this tile provides"
	/ Binabale-wala ang lahat na ani ng tile na ito

	Applicable to: Terrain

??? example  "Only [improvementFilter] improvements may be built on this tile"
	/ Mga [improvementFilter] na pagbubuti lamang ang maaaring itayo sa tile na ito
...
??? example  "Blocks line-of-sight from tiles at same elevation"
	/ Tinatabunan ang linya ng natatanaw mula sa mga tile na may parehong taas

	Applicable to: Terrain

??? example  "Has an elevation of [amount] for visibility calculations"
	/ Mayroong taas ng [amount] para sa mga kalkulasyon ng natatanaw
...
??? example  "[amount]% Chance to be destroyed by nukes"
	/ [amount]% Pagkakataon na mawasak ng mga nuke
...
??? example  "Can also be built on tiles adjacent to fresh water"
	/ Pwedeng itayo sa tiles malapit sa tubig-tabang

	Applicable to: Improvement

??? example  "[stats] from [tileFilter] tiles"
	/ [stats] mula sa [tileFilter] na mga tiles
...
??? example  "Ensures a minimum tile yield of [stats]"
	/ Nagsisiguro ng ani ng tile na hindi bababa ng [stats]
...
??? example  "Can be built outside your borders"
	/ Maaaring itayo sa labas ng iyong hangganan

	Applicable to: Improvement

??? example  "Can be built just outside your borders"
	/ Maaaring itayo sa labas lamang ng iyong mga hangganan

	Applicable to: Improvement

??? example  "Can only be built on [tileFilter] tiles"
	/ Maaaring itayo lamang sa mga [tileFilter] na tile
...
??? example  "Cannot be built on [tileFilter] tiles"
	/ Hindi maaaring itayo sa mga [tileFilter] na tile
...
??? example  "Can only be built to improve a resource"
	/ Maaari lamang itayo upang magpabuti ng isang pagkukunan
...
??? example  "Removes removable features when built"
	/ Tinatanggal ang mga naaalis na tampok kapag binuo

	Applicable to: Improvement

??? example  "Gives a defensive bonus of [relativeAmount]%"
	/ Nagbibigay ng dagdag na depensa ng [relativeAmount]%
...
??? example  "Costs [amount] [stat] per turn when in your territory"
	/ May bayad ng [amount] [stat] kada tira kapag nasa loob ng iyong nasasakupan
...
??? example  "Costs [amount] [stat] per turn"
	/ May bayad ng [amount] [stat] kada tira 
...
??? example  "Adjacent enemy units ending their turn take [amount] damage"
	/ Mga katabi na yunit ng kalaban na magtatapos ng tira nila ay makakatanggap ng [amount] pinsala
...
??? example  "Provides a random bonus when entered"
	/ Nagbibigay ng sapalarang bonus kapag napuntahan
...
??? example  "Pillaging this improvement yields approximately [stats]"
	/ Ang pagnanakaw sa pagbubuti na ito ay nagbubunga ng humigit-kumulang [stats]
...
??? example  "Pillaging this improvement yields [stats]"
	/ Ang pagnanakaw sa pagbubuti na ito ay magbibigay ng [stats]
...
??? example  "Deposits in [tileFilter] tiles always provide [amount] resources"
	/ Deposito sa loob ng [tileFilter] tiles ay tiyak na magbibigay ng [amount] na mapagkukunan
...
??? example  "Can only be created by Mercantile City-States"
	/ Maaaring magawa lamang ng mga Mangangalakal na Lungsod-Estado
...
??? example  "Guaranteed with Strategic Balance resource option"
	/ Garantisado kasama ng Estratehikong Balanse opsyon sa pagkukunan
...
??? example  "Free [unit] found in the ruins"
	/ Libreng [unit] matatagpuan sa mga guho
...
## CityState uniques（LungsodEstado）
??? example  "Provides military units every ≈[positiveAmount] turns"
	/ Nagbibigay ng mga yunit-militar kada ≈[positiveAmount] na tira 
...
??? example  "Provides a unique luxury"
	/ Nagbibigay ng isang natatanging karangyaan

	Applicable to: CityState

## ModOptions uniques（MgaModOpsyon）
...
## Conditional uniques（Kondisyonal）
!!! note ""
...
??? example  "&lt;with [nonNegativeAmount]% chance&gt;"
	/ nang may [nonNegativeAmount]% na pagkakataon
...
??? example  "&lt;when not at war&gt;"
	/ kung hindi nasa digmaan

	Applicable to: Conditional

??? example  "&lt;during a Golden Age&gt;"
	/ sa loob ng Ginintuang Panahon 
...
??? example  "&lt;during We Love The King Day&gt;"
	/ sa kasagsagan ng Araw ng Ating Mahal na Hari

	Applicable to: Conditional

??? example  "&lt;while the empire is happy&gt;"
	/ tuwing maligaya ang imperyo
...
??? example  "&lt;if starting in the [era]&gt;"
	/ kapag ito'y nagsisimula sa [era]
...
??? example  "&lt;if no other Civilization has researched this&gt;"
	/ kung walang sibilisasyon na nakasaliksik nito

	Applicable to: Conditional

??? example  "&lt;after discovering [techFilter]&gt;"
	/ pagkatapos madiskubre ang [techFilter] 
...
??? example  "&lt;before discovering [techFilter]&gt;"
	/ bago madiskubre ang [techFilter]
...
??? example  "&lt;after adopting [policy/belief]&gt;"
	/ pagkatapos ipagtibay ang [policy/belief]
...
??? example  "&lt;before adopting [policy/belief]&gt;"
	/ bago magtakda ng [policy/belief]
...
??? example  "&lt;before founding a Pantheon&gt;"
	/ bago itatag ang isang Panteon

	Applicable to: Conditional

??? example  "&lt;after founding a Pantheon&gt;"
	/ pagkatapos itatag ang isang Panteon

	Applicable to: Conditional

??? example  "&lt;before founding a religion&gt;"
	/ bago magtatag ng isang relihiyon

	Applicable to: Conditional

??? example  "&lt;after founding a religion&gt;"
	/ pagkatapos magtatag ng isang relihiyon

	Applicable to: Conditional

??? example  "&lt;before enhancing a religion&gt;"
	/ bago magpabuti ng isang relihiyon

	Applicable to: Conditional

??? example  "&lt;after enhancing a religion&gt;"
	/ pagkatapos magpabuti ng isang relihiyon
...
??? example  "&lt;if [buildingFilter] is constructed&gt;"
	/ kung itinayo ang [buildingFilter] 
...
??? example  "&lt;when above [amount] [stat/resource]&gt;"
	/ kapag nasa itaas ng [amount] [stat/resource]
...
??? example  "&lt;when below [amount] [stat/resource]&gt;"
	/ kapag nasa ibaba ng [amount] [stat/resource]
...
??? example  "&lt;in cities with a [buildingFilter]&gt;"
	/ sa mga lungsod na may isang [buildingFilter]
...
??? example  "&lt;in cities without a [buildingFilter]&gt;"
	/ sa mga lungsod na walang [buildingFilter]
...
??? example  "&lt;in cities with at least [positiveAmount] [populationFilter]&gt;"
	/ sa mga lungsod na hindi bababa ng [positiveAmount] [populationFilter]
...
??? example  "&lt;for [mapUnitFilter] units&gt;"
	/ para sa [mapUnitFilter] na yunit
...
??? example  "&lt;for units with [promotion]&gt;"
	/ para sa mga yunit na may [promotion]
...
??? example  "&lt;for units without [promotion]&gt;"
	/ para sa mga yunit na walang [promotion]
...
??? example  "&lt;vs cities&gt;"
	/ laban sa mga lungsod 

	Applicable to: Conditional

??? example  "&lt;vs [mapUnitFilter] units&gt;"
	/ laban sa mga [mapUnitFilter] na yunit
...
??? example  "&lt;when fighting units from a Civilization with more Cities than you&gt;"
	/ kapag nakikipaglaban ng yunit mula sa isang Sibilisasyon na may mas maraming lungsod sa iyo
...
??? example  "&lt;when fighting in [tileFilter] tiles&gt;"
	/ kapag lumalaban sa [tileFilter] tiles 
...
??? example  "&lt;on foreign continents&gt;"
	/ sa mga banyagang kontinente

	Applicable to: Conditional

??? example  "&lt;when adjacent to a [mapUnitFilter] unit&gt;"
	/ kapag magkalapit sa isang [mapUnitFilter] na yunit
...
??? example  "&lt;when above [positiveAmount] HP&gt;"
	/ kapag higit sa [positiveAmount] HP
...
??? example  "&lt;when below [positiveAmount] HP&gt;"
	/ kapag bababa sa [positiveAmount] HP
...
??? example  "&lt;if it hasn't used other actions yet&gt;"
	/ kung ito'y hindi pa gumamit ng ibang aksyon
...
??? example  "&lt;in [tileFilter] tiles&gt;"
	/ sa loob ng mga [tileFilter] na tile
...
??? example  "&lt;in tiles without [tileFilter]&gt;"
	/ sa mga tile na walang [tileFilter] 
...
??? example  "&lt;within [positiveAmount] tiles of a [tileFilter]&gt;"
	/ sa loob ng [positiveAmount] na tile ng isang [tileFilter] 
...
??? example  "&lt;on water maps&gt;"
	/ sa mapa na may tubig

	Applicable to: Conditional

??? example  "&lt;in [regionType] Regions&gt;"
	/ sa loob ng mga [regionType] na Rehiyon
...
??? example  "&lt;in all except [regionType] Regions&gt;"
	/ sa lahat ng mga Rehiyon maliban sa [regionType]
...
## TriggerCondition uniques（KondisyonNgPagpapagana）
!!! note ""
...
??? example  "&lt;upon adopting [policy/belief]&gt;"
	/ kapag nagpapatupad ng [policy/belief]
...
??? example  "&lt;upon declaring friendship&gt;"
	/ kapag nagdeklara ng pagkakaibigan
...
??? example  "&lt;upon entering a Golden Age&gt;"
	/ kapag nakapasok sa isang Ginintuang Panahon
...
??? example  "&lt;upon conquering a city&gt;"
	/ kapag nakalusob sa isang lungsod
...
??? example  "&lt;upon founding a city&gt;"
	/ kapag nagtatatag ng isang lungsod
...
??? example  "&lt;upon discovering a Natural Wonder&gt;"
	/ kapag nakadiskubre ng isang Likas na Yaman

	Applicable to: TriggerCondition

??? example  "&lt;upon constructing [buildingFilter]&gt;"
	/ kapag nagtatayo ng [buildingFilter]
...
??? example  "&lt;upon constructing [buildingFilter] [cityFilter]&gt;"
	/ kapag nagtatayo ng [buildingFilter] [cityFilter]
...
??? example  "&lt;upon gaining a [baseUnitFilter] unit&gt;"
	/ kapag nadagdagan ng [baseUnitFilter] yunit
...
??? example  "&lt;upon founding a Pantheon&gt;"
	/ kapag nagtatatag ng isang Panteon

	Applicable to: TriggerCondition

??? example  "&lt;upon founding a Religion&gt;"
	/ kapag nagtatatag ng isang Relihiyon

	Applicable to: TriggerCondition

??? example  "&lt;upon enhancing a Religion&gt;"
	/ kapag nagpapabuti ng isang Relihiyon
...
## UnitTriggerCondition uniques（KondisyonSaPagpapaganaNgYunit）
!!! note ""
...
??? example  "&lt;upon defeating a [mapUnitFilter] unit&gt;"
	/ kapag nakatalo ng isang [mapUnitFilter] na yunit
...
??? example  "&lt;upon losing at least [positiveAmount] HP in a single attack&gt;"
	/ kapag nabawasan ng hindi bababa ng [positiveAmount] HP sa isang pagatake
...
??? example  "&lt;upon ending a turn in a [tileFilter] tile&gt;"
	/ kapag nagtapaos ang tira sa isang [tileFilter] na tile 
...
??? example  "&lt;requires [nonNegativeAmount] movement&gt;"
	/ kinakailangan ng [nonNegativeAmount] na pagkilos
...
??? example  "&lt;[nonNegativeAmount] additional time(s)&gt;"
	/ [nonNegativeAmount] karagdagang (mga) oras 
...
??? example  "&lt;after which this unit is consumed&gt;"
	/ pagkatapos nito ay inaalay na ang yunit
...
??? example  "&lt;for [nonNegativeAmount] turns&gt;"
	/ hanggang sa [nonNegativeAmount] na tira 
