...
## Triggerable uniques（Vegetabilis）
!!! note ""
...
??? example  "Remove [buildingFilter] [cityFilter]"
	/ Summoveas [buildingFilter](m/s/um/os) [cityFilter]
...
??? example  "Sell [buildingFilter] buildings [cityFilter]"
	/ Vendas [buildingFilter](m/s/um/os) [cityFilter]
...
??? example  "Free [unit] appears"
	/ [unit] gratuitus/gratuita appareat
...
??? example  "[positiveAmount] free [unit] units appear"
	/ [positiveAmount] centuriæ gratuitæ, sint [unit], appareant
...
??? example  "Free Social Policy"
	/ Dictatum sociale gratuitum

	Applicable to: Triggerable

??? example  "[positiveAmount] Free Social Policies"
	/ [positiveAmount] dictata socialia gratuita
...
??? example  "Empire enters golden age"
	/ Imperium ingrediatur sæculum aureum

	Applicable to: Triggerable

??? example  "Empire enters a [positiveAmount]-turn Golden Age"
	/ Imperium ingrediatur sæculum aureum [positiveAmount] gressuum
...
??? example  "Free Great Person"
	/ Persona Magna gratuita

	Applicable to: Triggerable

??? example  "[amount] population [cityFilter]"
	/ [amount] multitudo [cityFilter]
...
??? example  "[amount] population in a random city"
	/ [amount] multitudo in urbem quæ decernatur passive (i.e. de cæcitate)
...
??? example  "Adopt [policy/belief]"
	/ Asciscas [policy/belief](m/s/um/os)
...
??? example  "Remove [policyFilter]"
	/ Expellas [policyFilter](m/s/um/os)
...
??? example  "Remove [policyFilter] and refund [amount]% of its cost"
	/ Expellas [policyFilter](m/s/um/os) et recipias [amount]% quam sumptum ejus
...
??? example  "Free Technology"
	/ Technologia gratuita

	Applicable to: Triggerable

??? example  "[positiveAmount] Free Technologies"
	/ [positiveAmount] Technologiæ gratuitæ
...
??? example  "[positiveAmount] free random researchable Tech(s) from the [eraFilter]"
	/ [positiveAmount] Technologia(e) gratuita(e) quæ decernantur passive (i.e. de cæcitate) de technologiis, quæ possint invenire, de [eraFilter]
...
??? example  "Reveals the entire map"
	/ Illustret tabulam omnem

	Applicable to: Triggerable

??? example  "Gain a free [beliefType] belief"
	/ Acquiras opinionem gratuitam quæ sit [beliefType]
...
??? example  "Triggers voting for the Diplomatic Victory"
	/ Feratis suffragium ad victoriam diplomaticam

	Applicable to: Triggerable

??? example  "Instantly consumes [positiveAmount] [stockpiledResource]"
	/ Confestim consumat [positiveAmount] [stockpiledResource](m/s/um/os)
...
??? example  "Instantly provides [positiveAmount] [stockpiledResource]"
	/ Confestim præbeat [positiveAmount] [stockpiledResource](m/s/um/os)
...
??? example  "Instantly gain [amount] [stockpile]"
	/ Confestim mereas [amount] [stockpile](m/s/um/os)
...
??? example  "Gain enough Faith for a Pantheon"
	/ Mereas satis fidem ad Pantheum

	Applicable to: Triggerable

??? example  "Gain enough Faith for [positiveAmount]% of a Great Prophet"
	/ Mereas fidem quæ sit [positiveAmount]% quam satis fidem ad prophetam magnum
...
??? example  "Gain control over [tileFilter] tiles in a [nonNegativeAmount]-tile radius"
	/ Fias compos tegularum quæ, sint [tileFilter], non absint pluribus quam [nonNegativeAmount] tegulis
...
??? example  "Gain control over [positiveAmount] tiles [cityFilter]"
	/ Fias compos [positiveAmount] tegularum [cityFilter]
...
??? example  "Reveal up to [positiveAmount/'all'] [tileFilter] within a [positiveAmount] tile radius"
	/ Illustret usque ad [positiveAmount/'all'] tegulas quæ, sint [tileFilter], non absint pluribus quam [positiveAmount] tegulis
...
??? example  "Promotes all spies [positiveAmount] time(s)"
	/ Promoveat emissarios omnes totiens quam [positiveAmount]
...
??? example  "Gain an extra spy"
	/ Acquiras emissarium addititium

	Applicable to: Triggerable

??? example  "Turn this tile into a [terrainName] tile"
	/ Mutet hanc tegulam in tegulam quæ sit [terrainName]
...
??? example  "Remove [resourceFilter] resources from this tile"
	/ Ex hac tegula emovere merces quæ sunt [resourceFilter]
...
??? example  "Remove [improvementFilter] improvements from this tile"
	/ Ex hac tegula emovere meliorationes quæ sunt [improvementFilter]
...
??? example  "Provides the cheapest [stat] building in your first [positiveAmount] cities for free"
	/ In [positiveAmount] urbibus primis tuis gratuito præbeat vilissima ædificia de [stat]
...
??? example  "Provides a [buildingName] in your first [positiveAmount] cities for free"
	/ In [positiveAmount] urbibus primis tuis gratuito præbeat ædificium quod sit [buildingName]
...
## UnitTriggerable uniques（Vegetabilis de Centuria）
!!! note ""
...
??? example  "[unitTriggerTarget] heals [positiveAmount] HP"
	/ [unitTriggerTarget] medeatur contra [positiveAmount] damnum
...
??? example  "[unitTriggerTarget] takes [positiveAmount] damage"
	/ [unitTriggerTarget] accipiat [positiveAmount] damnum
...
??? example  "[unitTriggerTarget] gains [amount] XP"
	/ [unitTriggerTarget] acquirat [amount] XP
...
??? example  "[unitTriggerTarget] upgrades for free"
	/ [unitTriggerTarget] gratuito armetur
...
??? example  "[unitTriggerTarget] upgrades for free including special upgrades"
	/ [unitTriggerTarget] gratuito (specialiter) armetur
...
??? example  "[unitTriggerTarget] gains the [promotion] promotion"
	/ [unitTriggerTarget] accipiat promotionem quæ est [promotion]
...
??? example  "[unitTriggerTarget] loses the [promotion] promotion"
	/ [unitTriggerTarget] perdat promotionem quæ est [promotion]
...
??? example  "[unitTriggerTarget] gains [positiveAmount] movement"
	/ [unitTriggerTarget] mereat [positiveAmount] momentum
...
??? example  "[unitTriggerTarget] loses [positiveAmount] movement"
	/ [unitTriggerTarget] perdat [positiveAmount] momentum
...
??? example  "[unitTriggerTarget] gains the [promotion] status for [positiveAmount] turn(s)"
	/ [unitTriggerTarget] mereat statum qui sit [promotion] in [positiveAmount] gressibus dehinc
...
??? example  "[unitTriggerTarget] loses the [promotion] status"
	/ [unitTriggerTarget] perdat statum qui est [promotion]
...
??? example  "[unitTriggerTarget] is destroyed"
	/ [unitTriggerTarget] interficiatur
...
??? example  "[stats] from every specialist [cityFilter]"
	/ [stats] ob omnem specialistam [cityFilter]
...
??? example  "[stats] per [positiveAmount] population [cityFilter]"
	/ [stats] ob [positiveAmount]-nam multitudinem [cityFilter]
...
??? example  "[stats] per [positiveAmount] social policies adopted"
	/ [stats] ob [positiveAmount]-na dictata socialia ascita
...
??? example  "[stats] per every [positiveAmount] [civWideStat]"
	/ [stats] ob [positiveAmount]-nos/na(s) [civWideStat](m/s/um/os)
...
??? example  "[stats] in cities on [terrainFilter] tiles"
	/ [stats] in urbibus in tegulis quæ sunt [terrainFilter]
...
??? example  "[stats] from all [buildingFilter] buildings"
	/ [stats] de ædificiis omnibus quæ sunt [buildingFilter]
...
??? example  "[stats] from [tileFilter] tiles [cityFilter]"
	/ [stats] de tegulis quæ sunt [tileFilter] [cityFilter]
...
??? example  "[relativeAmount]% [stat] from every [tileFilter/buildingFilter]"
	/ [relativeAmount]% [stat] de omni(bus) [tileFilter/buildingFilter](o/is)
...
??? example  "[relativeAmount]% Yield from every [tileFilter/buildingFilter]"
	/ [relativeAmount]% productum de omni(bus) [tileFilter/buildingFilter](o/is)
...
??? example  "[relativeAmount]% [stat] from City-States"
	/ [relativeAmount]% [stat] de civitatibus urbium
...
??? example  "[relativeAmount]% [stat] from Trade Routes"
	/ [relativeAmount]% [stat] de viis commercii
...
??? example  "Nullifies [stat] [cityFilter]"
	/ Dirimit [stat](m/s/um/os) [cityFilter]
...
??? example  "[relativeAmount]% Production when constructing [buildingFilter] buildings [cityFilter]"
	/ [relativeAmount]% Fabricationem quom [cityFilter] construunt ædificia quæ sint [buildingFilter]
...
??? example  "[relativeAmount]% Production when constructing [baseUnitFilter] units [cityFilter]"
	/ [relativeAmount]% Fabricationem quom [cityFilter] construunt centurias quæ sint [baseUnitFilter]
...
??? example  "[relativeAmount]% Production when constructing [buildingFilter] wonders [cityFilter]"
	/ [relativeAmount]% Fabricationem quom [cityFilter] construunt miracula quæ sint [buildingFilter]
...
??? example  "[relativeAmount]% Production towards any buildings that already exist in the Capital"
	/ [relativeAmount]% Fabricatio ad ædificium quod cumque in metropoli jam est
...
??? example  "[relativeAmount]% Yield from pillaging tiles"
	/ [relativeAmount]% productum de diripiendo
...
??? example  "[relativeAmount]% Health from pillaging tiles"
	/ [relativeAmount]% Sanitatem de diripiendo
...
??? example  "Military Units gifted from City-States start with [positiveAmount] XP"
	/ Centuriæ militares, quas civitates urbium donent, cum [positiveAmount] experientia incipiant
...
??? example  "Militaristic City-States grant units [positiveAmount] times as fast when you are at war with a common nation"
	/ Quom belli contra nationem pleram es, militares civitates urbium [positiveAmount]-plici celeritate donent centurias
...
??? example  "Gifts of Gold to City-States generate [relativeAmount]% more Influence"
	/ Dona solidorum danda civitatibus urbium [relativeAmount]% majore generent influentiam
...
??? example  "Can spend Gold to annex or puppet a City-State that has been your Ally for [nonNegativeAmount] turns"
	/ Potes per consumptionem solidorum affigere aut municipium facere civitatem urbis quæ et sit et esset socia tua in [nonNegativeAmount] gressibus
...
??? example  "City-State territory always counts as friendly territory"
	/ Terra civitatis urbis semper adnumeratur terra amica

	Applicable to: Global

??? example  "Allied City-States will occasionally gift Great People"
	/ Civitates sociæ urbium nonnumquam donant personas magnas

	Applicable to: Global

??? example  "[relativeAmount]% City-State Influence degradation"
	/ [relativeAmount]% deminutio influentiæ civitatibus urbium
...
??? example  "Resting point for Influence with City-States is increased by [amount]"
	/ Punctum acclinandum de influentia civitatibus urbium cum [amount] adicitur
...
??? example  "Allied City-States provide [stat] equal to [relativeAmount]% of what they produce for themselves"
	/ Civitates sociæ urbium præbent [stat](m/s/um/os) qui/quæ est [relativeAmount]% quam eæ faciunt sibi
...
??? example  "[relativeAmount]% resources gifted by City-States"
	/ [relativeAmount]% merces quas civitates urbium donent
...
??? example  "[relativeAmount]% Happiness from luxury resources gifted by City-States"
	/ [relativeAmount]% Felicitas de mercibus luxuriis quas civitates urbium donent
...
??? example  "City-State Influence recovers at twice the normal rate"
	/ Influentia civitatibus urbium duplâ proportione recipitur quam cotidiana

	Applicable to: Global

??? example  "[relativeAmount]% growth [cityFilter]"
	/ [relativeAmount]% auctus [cityFilter]
...
??? example  "[amount]% Food is carried over after population increases [cityFilter]"
	/ [amount]% Cibus [cityFilter] transferatur post auctum de multitudine
...
??? example  "[relativeAmount]% unhappiness from the number of cities"
	/ [relativeAmount]% ira de numero urbium
...
??? example  "[relativeAmount]% Unhappiness from [populationFilter] [cityFilter]"
	/ [relativeAmount]% Ira de [populationFilter](o/is) [cityFilter]
...
??? example  "[amount] Happiness from each type of luxury resource"
	/ [amount] Felicitas ob omne genus mercis luxuriæ
...
??? example  "Retain [relativeAmount]% of the happiness from a luxury after the last copy has been traded away"
	/ Contineas [relativeAmount]% quam felicitas de luxuria postquam exemplar postremum ob commercium amittatur
...
??? example  "[relativeAmount]% of excess happiness converted to [stat]"
	/ [relativeAmount]% quam felicitas superflua ad [stat](m/s/um/os) vertitur
...
??? example  "Cannot build [baseUnitFilter] units"
	/ Non potest ædificare centurias quæ sunt [baseUnitFilter]
...
??? example  "Enables construction of Spaceship parts"
	/ Habilitat constructionem partium Astronavis

	Applicable to: Global

??? example  "May buy [baseUnitFilter] units for [nonNegativeAmount] [stat] [cityFilter] at an increasing price ([amount])"
	/ Licet [cityFilter] [amount] [stat](o/is) emere centurias quæ sunt [baseUnitFilter] (impendium cum [nonNegativeAmount] accumuletur)
...
??? example  "May buy [buildingFilter] buildings for [nonNegativeAmount] [stat] [cityFilter] at an increasing price ([amount])"
	/ Licet [cityFilter] [amount] [stat](o/is) emere ædificia quæ sunt [buildingFilter] (impendium cum [nonNegativeAmount] accumuletur)
...
??? example  "May buy [baseUnitFilter] units for [nonNegativeAmount] [stat] [cityFilter]"
	/ Licet [cityFilter] [nonNegativeAmount] [stat](o/is) emere centurias quæ sunt [baseUnitFilter]
...
??? example  "May buy [buildingFilter] buildings for [nonNegativeAmount] [stat] [cityFilter]"
	/ Licet [cityFilter] [nonNegativeAmount] [stat](o/is) emere ædificia quæ sunt [buildingFilter]
...
??? example  "May buy [baseUnitFilter] units with [stat] [cityFilter]"
	/ Licet [cityFilter] [stat](o/is) emere centurias quæ sunt [baseUnitFilter]
...
??? example  "May buy [buildingFilter] buildings with [stat] [cityFilter]"
	/ Licet [cityFilter] [stat](o/is) emere ædificia quæ sunt [buildingFilter]
...
??? example  "May buy [baseUnitFilter] units with [stat] for [nonNegativeAmount] times their normal Production cost"
	/ Licet emere centurias quæ sunt [baseUnitFilter] [stat](o/is) qui/quæ si(n)t [nonNegativeAmount]-plex quam sumptus cotidianus fabricationis earum
...
??? example  "May buy [buildingFilter] buildings with [stat] for [nonNegativeAmount] times their normal Production cost"
	/ Licet emere ædificia quæ sunt [buildingFilter] [stat](o/is) qui/quæ si(n)t [nonNegativeAmount]-plex quam sumptus cotidianus fabricationis eorum
...
??? example  "[stat] cost of purchasing items in cities [relativeAmount]%"
	/ [relativeAmount]% [stat] sumend* rerum emendarum in urbibus
...
??? example  "[stat] cost of purchasing [buildingFilter] buildings [relativeAmount]%"
	/ [relativeAmount]% [stat] sumend* emendorum ædificiorum quæ sunt [buildingFilter]
...
??? example  "[stat] cost of purchasing [baseUnitFilter] units [relativeAmount]%"
	/ [relativeAmount]% [stat] sumend* emendarum centuriarum quæ sunt [baseUnitFilter]
...
??? example  "Enables conversion of city production to [civWideStat]"
	/ Habilitat versionem a fabricatione de urbe ad [civWideStat](m/s/um/os)
...
??? example  "Improves movement speed on roads"
	/ Meliorat celeritatem de motu in viis

	Applicable to: Global

??? example  "Roads connect tiles across rivers"
	/ Viæ trans fluvios concatenant tegulas

	Applicable to: Global

??? example  "[relativeAmount]% maintenance on road & railroads"
	/ [relativeAmount]% sumptus tuitionis viarum & viarum ferrearum
...
??? example  "No Maintenance costs for improvements in [tileFilter] tiles"
	/ Nullus sumptus est ad tuendas meliorationes in tegulis quæ sunt [tileFilter]
...
??? example  "[relativeAmount]% construction time for [improvementFilter] improvements"
	/ [relativeAmount]% tempus construendarum meliorationum quæ sunt [improvementFilter]
...
??? example  "[relativeAmount]% maintenance cost for [buildingFilter] buildings [cityFilter]"
	/ [relativeAmount]% sumptus tuendorum ædificiorum quæ sunt [buildingFilter] [cityFilter]
...
??? example  "[relativeAmount]% Culture cost of natural border growth [cityFilter]"
	/ [relativeAmount]% Cultura sumenda ad naturaliter dilatandum fines [cityFilter]
...
??? example  "[relativeAmount]% Gold cost of acquiring tiles [cityFilter]"
	/ [relativeAmount]% solidi sumendi ad tegulas acquirendas [cityFilter]
...
??? example  "Each city founded increases culture cost of policies [relativeAmount]% less than normal"
	/ Singulæ urbes conditæ sumptum culturæ dictati [relativeAmount]% minore adiciunt quam cotidiano
...
??? example  "[relativeAmount]% Culture cost of adopting new Policies"
	/ [relativeAmount]% Cultura sumenda ad ascitum dictati novi
...
??? example  "Each city founded increases Science cost of Technologies [relativeAmount]% less than normal"
	/ Singulæ urbes conditæ sumptum scientiæ technologiæ [relativeAmount]% minore adiciunt quam cotidiano
...
??? example  "[stats] for every known Natural Wonder"
	/ [stats] ob omne scitum miraculum naturale
...
??? example  "[relativeAmount]% Great Person generation [cityFilter]"
	/ [relativeAmount]% generatio personæ magnæ [cityFilter]
...
??? example  "[relativeAmount]% Gold from Great Merchant trade missions"
	/ [relativeAmount]% solidi merendi ob missionem commercialem mercatoris magni
...
??? example  "Great General provides double combat bonus"
	/ Dux magnus præbet additionem duplam ad prœlium
...
??? example  "Receive a free Great Person at the end of every [comment] (every 394 years), after researching [tech]. Each bonus person can only be chosen once."
	/ Accipias personam magnam in fine omnis [comment] (394 anni) postquam invenis [tech](m/um). Singulæ personæ magnæ addititiæ modo possunt semel eligi.
...
??? example  "Once The Long Count activates, the year on the world screen displays as the traditional Mayan Long Count."
	/ Quando Numeratio Longinqua vegetur, annus in ostentu mundi in tralaticiâ numeratione longinquâ Mayensi ostendatur.

	Applicable to: Global

??? example  "[amount] Unit Supply"
	/ [amount] Supplementum centuriarum
...
??? example  "[amount] Unit Supply per [positiveAmount] population [cityFilter]"
	/ [amount] Supplementum centuriarum ob [positiveAmount]-nam multitudinem [cityFilter]
...
??? example  "[amount] Unit Supply per city"
	/ [amount] Supplementum centuriarum ob urbem omnem
...
??? example  "[amount] units cost no maintenance"
	/ [amount] centuriæ sumunt nullum ad tuendum
...
??? example  "Units in cities cost no Maintenance"
	/ Centuriæ in urbibus sumunt nullum ad tuendum

	Applicable to: Global

??? example  "Enables embarkation for land units"
	/ Habilitat centurias terræ ad conscendendum (in naves)
...
??? example  "Enables [mapUnitFilter] units to enter ocean tiles"
	/ Habilitat centurias quæ sunt [mapUnitFilter] ad ingressum in tegulas Oceani
...
??? example  "Land units may cross [terrainName] tiles after the first [baseUnitFilter] is earned"
	/ Centuriæ terræ possunt ire trans tegulas, quæ sunt [terrainName], postquam [baseUnitFilter] primus est meritus
...
??? example  "Enemy [mapUnitFilter] units must spend [positiveAmount] extra movement points when inside your territory"
	/ Necesse est centuriis hostilibus quæ sunt [mapUnitFilter] consumere [positiveAmount] addititios calculos movendi quom in tua terra sunt
...
??? example  "New [baseUnitFilter] units start with [amount] XP [cityFilter]"
	/ Novæ centuriæ quæ sunt [baseUnitFilter] [cityFilter] cum [amount] XP incipiunt
...
??? example  "All newly-trained [baseUnitFilter] units [cityFilter] receive the [promotion] promotion"
	/ Centuriæ [cityFilter] noviter educandæ accipiant promotionem quæ est [promotion] si illæ sunt [baseUnitFilter]
...
??? example  "[mapUnitFilter] Units adjacent to this city heal [amount] HP per turn when healing"
	/ Centuriæ, quæ sunt [mapUnitFilter] adjacen*s ad hanc urbem, medentur contra [amount] damnum cum medentur omni gressu
...
??? example  "[relativeAmount]% XP required for promotions"
	/ [relativeAmount]% XP requiritur ad promotiones
...
??? example  "[relativeAmount]% City Strength from defensive buildings"
	/ [relativeAmount]% Potentia urbis de ædificiis de defensione
...
??? example  "[relativeAmount]% Strength for cities"
	/ [relativeAmount]% Potentiam urbibus
...
??? example  "Provides [amount] [resource]"
	/ Præbet [amount] [resource](m/s/um/os)
...
??? example  "[relativeAmount]% [resourceFilter] resource production"
	/ [relativeAmount]% productum mercium quæ sunt [resourceFilter]
...
??? example  "Enables Open Borders agreements"
	/ Habilitat concordiam de apertione finium

	Applicable to: Global

??? example  "Enables Research agreements"
	/ Habilitat concordiam de scientia

	Applicable to: Global

??? example  "Science gained from research agreements [relativeAmount]%"
	/ [relativeAmount]% Scientia merenda ob concordiam de scientia
...
??? example  "Enables Defensive Pacts"
	/ Habilitat fœdera de defensione

	Applicable to: Global

??? example  "When declaring friendship, both parties gain a [relativeAmount]% boost to great person generation"
	/ Quando indicit amicitiam, ambo accipiant [relativeAmount]% additionem generationis personarum magnarum
...
??? example  "Influence of all other civilizations with all city-states degrades [relativeAmount]% faster"
	/ Influentia omnis aliæ civilizationis omnibus civitatibus urbium [relativeAmount]% addititia celeritate decrescit
...
??? example  "Gain [amount] Influence with a [baseUnitFilter] gift to a City-State"
	/ Mereas [amount] influentiam cum donas [baseUnitFilter](m/um) civitatibus urbium
...
??? example  "Resting point for Influence with City-States following this religion [amount]"
	/ Punctum acclinandum de influentia civitatibus urbium quæ sequuntur hanc religionem [amount]
...
??? example  "Notified of new Barbarian encampments"
	/ Nova castra barbarorum nuntientur
...
??? example  "When conquering an encampment, earn [amount] Gold and recruit a Barbarian unit"
	/ Quandocumque capis castra, mereas [amount] solidos et conscribas unam centuriam barbaram
...
??? example  "When defeating a [mapUnitFilter] unit, earn [amount] Gold and recruit it"
	/ Quando vincis contra centuriam quæ est [mapUnitFilter], mereas [amount] solidos et conscribas eam
...
??? example  "May choose [amount] additional [beliefType] beliefs when [foundingOrEnhancing] a religion"
	/ Licet eligere [amount] opiniones addititias, quæ sint [beliefType], cum [foundingOrEnhancing] religionem
...
??? example  "May choose [amount] additional belief(s) of any type when [foundingOrEnhancing] a religion"
	/ Licet eligere [amount] opiniones addititias cujusquam generis, cum [foundingOrEnhancing] religionem
...
??? example  "[stats] when a city adopts this religion for the first time"
	/ [stats] quandocumque una urbs hanc religionem primitus asciscit
...
??? example  "[relativeAmount]% Natural religion spread [cityFilter]"
	/ [relativeAmount]% stratus naturalis religionis [cityFilter]
...
??? example  "Religion naturally spreads to cities [amount] tiles away"
	/ Religio naturaliter sternitur ad urbes quæ [amount] tegulis absunt
...
??? example  "May not generate great prophet equivalents naturally"
	/ Nec propheta magnus nec æquivalens suus potest naturaliter oriri

	Applicable to: Global

??? example  "[relativeAmount]% Faith cost of generating Great Prophet equivalents"
	/ [relativeAmount]% Fides sumenda ad generatio prophetæ magni vel æquivalentis ejus
...
??? example  "[relativeAmount]% spy effectiveness [cityFilter]"
	/ [relativeAmount]% efficacia emissariorum [cityFilter]
...
??? example  "[relativeAmount]% enemy spy effectiveness [cityFilter]"
	/ [relativeAmount]% efficacia emissariorum hostilium [cityFilter]
...
??? example  "New spies start with [amount] level(s)"
	/ Emissarii novi cum [amount] gradibus incipiunt
...
??? example  "Triggers a Cultural Victory upon completion"
	/ Quando perficitur, quando victoria eruditionis est

	Applicable to: Global

??? example  "May buy items in puppet cities"
	/ Licet emere res in municipiis

	Applicable to: Global

??? example  "May not annex cities"
	/ Non licet affigere urbes

	Applicable to: Global

??? example  ""Borrows" city names from other civilizations in the game"
	/ Ab aliis civilizationibus in ludo "mutuatur" nomina urbium

	Applicable to: Global

??? example  "Cities are razed [amount] times as fast"
	/ Urbes [amount]-plici celeritate exscinduntur
...
??? example  "Receive a tech boost when scientific buildings/wonders are built in capital"
	/ Accipis additionem de technologia quando ædificia/miracula scientifica in metropoli perficiuntur

	Applicable to: Global

??? example  "[relativeAmount]% Golden Age length"
	/ [relativeAmount]% longinquitas saeculi aurei
...
??? example  "Population loss from nuclear attacks [relativeAmount]% [cityFilter]"
	/ [relativeAmount]% multitudo amittenda [cityFilter] ob oppugnationes nucleares
...
??? example  "Damage to garrison from nuclear attacks [relativeAmount]% [cityFilter]"
	/ Damnum centuriæ castellanæ de oppugnationibus nuclearibus [relativeAmount]% [cityFilter]
...
??? example  "Rebel units may spawn"
	/ Centuriæ rebelles possunt exsistere
...
??? example  "[relativeAmount]% Strength decreasing with distance from the capital"
	/ [relativeAmount]% Potentiam, quæ decrescit cum distantia a metropoli
...
??? example  "[relativeAmount]% to Flank Attack bonuses"
	/ [relativeAmount]% ad additiones de oppugnatione alæ
...
??? example  "[amount] additional attacks per turn"
	/ [amount] oppugnationes addititias omni gressu
...
??? example  "[relativeAmount] Air Interception Range"
	/ [relativeAmount] Ambitus interceptionis aeriæ
...
??? example  "[relativeAmount]% Spread Religion Strength"
	/ [relativeAmount]% Potentia ad sternendum religionem
...
??? example  "When spreading religion to a city, gain [amount] times the amount of followers of other religions as [stat]"
	/ Cum religionem in urbem sternis, mereas [stat](m/s/um/os) qui/quæ est [amount]-plex quam numerus assectatorum aliarum religionum
...
??? example  "Ranged attacks may be performed over obstacles"
	/ Oppugnationes longinquæ possunt per obstaculum fieri

	Applicable to: Global, Unit

??? example  "No defensive terrain bonus"
	/ Præmium defensionis de forma humi non est

	Applicable to: Global, Unit

??? example  "No defensive terrain penalty"
	/ Pœna ob formam humi de defensione non est

	Applicable to: Global, Unit

??? example  "No damage penalty for wounded units"
	/ Pœna ad damnum de centuria plagata non est

	Applicable to: Global, Unit

??? example  "Unable to capture cities"
	/ Non potest urbes capere

	Applicable to: Global, Unit

??? example  "Unable to pillage tiles"
	/ Non potest tegulas diripere

	Applicable to: Global, Unit

??? example  "No movement cost to pillage"
	/ Momentum non est consumendum ad diripiendum

	Applicable to: Global, Unit

??? example  "May heal outside of friendly territory"
	/ Potest mederi extra terram amicam

	Applicable to: Global, Unit

??? example  "All healing effects doubled"
	/ Effectus medicus omnis duplicatur

	Applicable to: Global, Unit

??? example  "Heals [amount] damage if it kills a unit"
	/ Medetur contra [amount] damnum si centuriam interficit
...
??? example  "Can only heal by pillaging"
	/ Modo potest mederi per direptionem

	Applicable to: Global, Unit

??? example  "[relativeAmount]% maintenance costs"
	/ [relativeAmount]% sumptus tuendi
...
??? example  "[relativeAmount]% Gold cost of upgrading"
	/ [relativeAmount]% Solidi consumendi ad armandum
...
??? example  "Earn [amount]% of the damage done to [combatantFilter] units as [stockpile]"
	/ Mereas [stockpile](m/s/um/os) qui/quæ si(n)t [amount]% quam damna data centuriis quæ sunt [combatantFilter]
...
??? example  "Upon capturing a city, receive [amount] times its [stat] production as [stockpile] immediately"
	/ Statim quam urbem capis, mereas [stockpile](m/s/um/os) qui/quæ si(n)t [amount]-plex quam [stat] qu*m ea facit
...
??? example  "Earn [amount]% of killed [mapUnitFilter] unit's [costOrStrength] as [stockpile]"
	/ Mereas [stockpile](m/s/um/os) qui/quæ si(n)t [amount]% quam [costOrStrength] centuriæ interfectæ quæ fuerit [mapUnitFilter]
...
??? example  "[amount] XP gained from combat"
	/ [amount] XP acquirenda ob prœlium
...
??? example  "[relativeAmount]% XP gained from combat"
	/ [relativeAmount]% XP acquirenda ob prœlium
...
??? example  "[greatPerson] is earned [relativeAmount]% faster"
	/ [greatPerson] est [relativeAmount]% addititia celeritate merendus
...
??? example  "[nonNegativeAmount] Movement point cost to disembark"
	/ [nonNegativeAmount] momentum sumendum ad applicandum ad terram
...
??? example  "[nonNegativeAmount] Movement point cost to embark"
	/ [nonNegativeAmount] momentum sumendum ad conscendendum
...
## Nation uniques（Populus）
??? example  "Starts with [tech]"
	/ Incipit cum [tech](o/is)
...
??? example  "Starts with [policy] adopted"
	/ [policy] est ascitum quom incipit
...
??? example  "All units move through Forest and Jungle Tiles in friendly territory as if they have roads. These tiles can be used to establish City Connections upon researching the Wheel."
	/ Centuriæ omnes movent per tegulas silvarum et silvarum tropicarum in terra amica acsi habeant vias. Hæ tegulæ possunt adhiberi ad catenationes urbium quando Rota est inventa.
...
??? example  "Units ignore terrain costs when moving into any tile with Hills"
	/ Centuriæ neglegunt sumptus de forma humi quom moventur in unam tegulam cum collibus
...
## Personality uniques（Persona）
??? example  "Will not build [baseUnitFilter/buildingFilter]"
	/ Non ædificabit [baseUnitFilter/buildingFilter](m/um)
...
??? example  "Starting in this era disables religion"
	/ Debilitat religionem usque ab hac ætate

	Applicable to: Era

??? example  "Every major Civilization gains a spy once a civilization enters this era"
	/ Omnis civilizatio plera acquirat unum emissarium postquam aliqua civilizatio ingreditur hanc ætatem

	Applicable to: Era

## Tech uniques（Technologia）
??? example  "Starting tech"
	/ Technologia initialis

	Applicable to: Tech

??? example  "Can be continually researched"
	/ Potest assidue exquiri
...
## FounderBelief uniques（Opinio Institutoris）
!!! note ""
...
??? example  "[stats] for each global city following this religion"
	/ [stats] ob urbem omnem quæ in mundo sequitur hanc religionem
...
??? example  "[stats] from every [positiveAmount] global followers [cityFilter]"
	/ [stats] de [positiveAmount]-nis assectatoribus [cityFilter] in mundo
...
## FollowerBelief uniques（Opinio Assectatorum）
!!! note ""
...
??? example  "Earn [amount]% of [mapUnitFilter] unit's [costOrStrength] as [stockpile] when killed within 4 tiles of a city following this religion"
	/ Mereas [stockpile](m/s/um/os) qui/quæ si(n)t [amount]% quam [costOrStrength] centuriæ, quæ fuerit [mapUnitFilter], si interficeretur quom abforet non pluribus quam 4 tegulis ab urbe quæ sequitur hanc religionem
...
??? example  "Consumes [amount] [resource]"
	/ Sumit [amount] [resource](m/s/um/os)
...
??? example  "Costs [amount] [stockpiledResource]"
	/ Consumit [amount] [stockpiledResource](m/s/um/os)
...
??? example  "Can be purchased with [stat] [cityFilter]"
	/ Potest [stat](o/is) emi [cityFilter]
...
??? example  "Can be purchased for [amount] [stat] [cityFilter]"
	/ Potest [amount] [stat](o/is) emi [cityFilter]
...
??? example  "Limited to [amount] per Civilization"
	/ Finis est sic nulla civilizatio potest plures quam [amount] habere
...
??? example  "Excess Food converted to Production when under construction"
	/ Cum construitur, cibus superfluus ad fabricationem vertitur

	Applicable to: Building, Unit

??? example  "Requires at least [amount] population"
	/ Requirit multitudinem non pauciorem quam [amount]
...
??? example  "Triggers a global alert upon build start"
	/ Faciat admonitionem mundi quando ædificatio incipitur

	Applicable to: Building, Unit

??? example  "Triggers a global alert upon completion"
	/ Faciat admonitionem mundi quando completur

	Applicable to: Building, Unit

??? example  "Cost increases by [amount] per owned city"
	/ Sumptus cum [amount] additur ob omnem urbem possessam
...
??? example  "Cost increases by [amount] when built"
	/ Sumptus cum [amount] additur quando ædificatum sit
...
??? example  "Must have an owned [tileFilter] within [amount] tiles"
	/ Necesse est habere tegulam quæ sit [tileFilter] et absit non pluribus quam [amount] tegulis
...
??? example  "Must not be on [tileFilter]"
	/ Necesse est inesse in tegula quæ non sit [tileFilter]
...
??? example  "Must not be next to [tileFilter]"
	/ Necesse est non adjacere ad tegulam quæ est [tileFilter]
...
??? example  "Moves to new capital when capital changes"
	/ Movetur in metropolim novam quando metropolis mutatur

	Applicable to: Building

??? example  "Provides 1 extra copy of each improved luxury resource near this City"
	/ Præbet 1 exemplar addititium omnis mercis luxuriæ propinquæ hujus urbis

	Applicable to: Building

??? example  "Destroyed when the city is captured"
	/ Destruitur cum urbs capitur

	Applicable to: Building

??? example  "Never destroyed when the city is captured"
	/ Numquam destruitur cum urbs capitur
...
??? example  "Removes extra unhappiness from annexed cities"
	/ Emovet iram addititiam ex urbibus affixis

	Applicable to: Building

??? example  "Connects trade routes over water"
	/ Per aquam concatenat vias commercii

	Applicable to: Building

??? example  "Automatically built in all cities where it is buildable"
	/ Per automataria ædificabitur in omnibus urbibus quibus ædificari possit

	Applicable to: Building

??? example  "Creates a [improvementName] improvement on a specific tile"
	/ In tegula speciali creat meliorationem quæ sit [improvementName]
...
??? example  "Can carry [amount] extra [mapUnitFilter] units"
	/ Potest gerere [amount] centurias addititias quæ sunt [mapUnitFilter]
...
## UnitAction uniques（Actio Centuriae）
!!! note ""
...
??? example  "Founds a new puppet city"
	/ Condit novum municipium

	Applicable to: UnitAction

??? example  "Can instantly construct a [improvementFilter] improvement"
	/ Potest confestim construere melorationem quæ sit [improvementFilter]
...
??? example  "Can Spread Religion"
	/ Potest sternere religionem

	Applicable to: UnitAction

??? example  "Can remove other religions from cities"
	/ Potest religiones alias ex urbibus emovere

	Applicable to: UnitAction

??? example  "May found a religion"
	/ Potest fundare religionem

	Applicable to: UnitAction

??? example  "May enhance a religion"
	/ Potest amplificare religionem

	Applicable to: UnitAction

??? example  "Can transform to [unit]"
	/ Potest mutari in [unit](m/s/um/os)
...
??? example  "May create improvements on water resources"
	/ Potest creare melorationes super merces aquaticas

	Applicable to: Unit

??? example  "Can build [improvementFilter/terrainFilter] improvements on tiles"
	/ Potest in tegulis ædificare melorationes quæ sint [improvementFilter/terrainFilter]
...
??? example  "Can be added to [comment] in the Capital"
	/ Potest addici ad [comment](m/s/um/os) in Metropoli
...
??? example  "Prevents spreading of religion to the city it is next to"
	/ Prohibet sternere religionem in urbem adjacentem ad eum

	Applicable to: Unit

??? example  "Removes other religions when spreading religion"
	/ Emovet alias religiones quom sternit religionem

	Applicable to: Unit

??? example  "May Paradrop to [tileFilter] tiles up to [positiveAmount] tiles away"
	/ Potest de aeroplano cadere ad tegulas quæ sunt [tileFilter] et non pluribus quom [positiveAmount] tegulis absunt
...
??? example  "Can speed up construction of a building"
	/ Potest properare constructionem ædificii

	Applicable to: Unit

??? example  "Can speed up the construction of a wonder"
	/ Potest properare constructionem miraculi

	Applicable to: Unit

??? example  "Can hurry technology research"
	/ Potest properare inventionem technologiæ

	Applicable to: Unit

??? example  "Can generate a large amount of culture"
	/ Culturam multam generare potest

	Applicable to: Unit

??? example  "Can undertake a trade mission with City-State, giving a large sum of gold and [amount] Influence"
	/ Potest agere missionem commercialem civitatibus urbium, qua det aliquantum multum solidorum et [amount] influentiam
...
??? example  "[relativeAmount]% Strength for enemy [mapUnitFilter] units in adjacent [tileFilter] tiles"
	/ [relativeAmount]% Potentiam centuriis hostilibus quæ sunt [mapUnitFilter] in tegulis adjacentibus quæ sunt [tileFilter]
...
??? example  "[relativeAmount]% Strength bonus for [mapUnitFilter] units within [amount] tiles"
	/ [relativeAmount]% Potentiam addititiam centuriis quæ, sunt [mapUnitFilter], non absunt pluribus quam [amount] tegulis
...
??? example  "Can only attack [combatantFilter] units"
	/ Modo potest appugnare centurias quæ sunt [combatantFilter]
...
??? example  "Can only attack [tileFilter] tiles"
	/ Modo potest appugnare ad tegulas quæ sunt [tileFilter]
...
??? example  "Nuclear weapon of Strength [amount]"
	/ Arma atomica cum [amount] potentia
...
??? example  "Can move after attacking"
	/ Potest movere postquam appugnat

	Applicable to: Unit

??? example  "Transfer Movement to [mapUnitFilter]"
	/ Dat momentum centuriæ quæ sit [mapUnitFilter]
...
??? example  "Can move immediately once bought"
	/ Potest moveri statim quam emitur
...
??? example  "Unit will heal every turn, even if it performs an action"
	/ Centuria omni gressu medetur etsi agat

	Applicable to: Unit

??? example  "All adjacent units heal [amount] HP when healing"
	/ Centuriæ adjacentes omnes medentur contra [amount] damnum cum medentur
...
??? example  "Can see over obstacles"
	/ Potest per obstaculum videre

	Applicable to: Unit

??? example  "Can carry [amount] [mapUnitFilter] units"
	/ Potest gerere [amount] centurias quæ sunt [mapUnitFilter]
...
??? example  "Cannot be carried by [mapUnitFilter] units"
	/ Non potest geri centuriis quæ sunt [mapUnitFilter]
...
??? example  "[relativeAmount]% chance to intercept air attacks"
	/ Intercipiet oppugnationem aeriam cum probabilitate [relativeAmount]%
...
??? example  "Damage taken from interception reduced by [relativeAmount]%"
	/ Damnum accipiendum de interceptione est minuendum ut [relativeAmount]% ejus elimine(n)tur
...
??? example  "[relativeAmount]% Damage when intercepting"
	/ [relativeAmount]% Damnum cum intercipit
...
??? example  "[amount] extra interceptions may be made per turn"
	/ [amount] interceptiones addititiæ omni gressu possunt fieri
...
??? example  "Cannot be intercepted"
	/ Non potest intercipi

	Applicable to: Unit

??? example  "Cannot intercept [mapUnitFilter] units"
	/ Non potest intercipere centurias quæ sunt [mapUnitFilter]
...
??? example  "[relativeAmount]% Strength when performing Air Sweep"
	/ Cum verrit aëra, [relativeAmount]% potentiam
...
??? example  "May capture killed [mapUnitFilter] units"
	/ Potest capere centurias interfectas quæ fuerint [mapUnitFilter]
...
??? example  "Invisible to others"
	/ Non potest aliis videri

	Applicable to: Unit

??? example  "Invisible to non-adjacent units"
	/ Non potest videri centuriis non adjacentibus

	Applicable to: Unit

??? example  "Can see invisible [mapUnitFilter] units"
	/ Potest videre centurias invisibiles quæ sunt [mapUnitFilter]
...
??? example  "May upgrade to [unit] through ruins-like effects"
	/ Potest per effectum similem parietinis armari ut fiat [unit]
...
??? example  "Destroys tile improvements when attacking"
	/ Destruit meliorationem cum appugnat
...
??? example  "Double movement in [terrainFilter]"
	/ Duplicat momentum in tegulis quæ sunt [terrainFilter]
...
??? example  "All tiles cost 1 movement"
	/ Tegulæ omnes sumunt 1 momentum
...
??? example  "May travel on Water tiles without embarking"
	/ Potest ire in tegulis aquæ etsi non est in nave
...
??? example  "Can pass through impassable tiles"
	/ Potest gradi per tegulas invias, i. e., per tegulas non pervias
...
??? example  "Ignores terrain cost"
	/ Neglegit sumptum de forma humi
...
??? example  "Can enter ice tiles"
	/ Potest in tegulas glacierum inire
...
??? example  "Cannot embark"
	/ Non potest in navem ascendere

	Applicable to: Unit

??? example  "Cannot enter ocean tiles"
	/ Non potest in tegulas Oceani inire

	Applicable to: Unit

??? example  "May enter foreign tiles without open borders"
	/ Potest in tegulas alienas sine finibus apertis ingredi
...
??? example  "May enter foreign tiles without open borders, but loses [amount] religious strength each turn it ends there"
	/ Potest in tegulas alienas sine finibus apertis ingredi, sed amittat [amount] potentiam religiosam gressu quo cumque ibi est cum gressus perficitur
...
??? example  "Takes your religion over the one in their birth city"
	/ Asciscit religionem tuam pro illa in sua urbe natali

	Applicable to: Unit

??? example  "Great Person - [comment]"
	/ Persona Magna - [comment]
...
??? example  "Is part of Great Person group [comment]"
	/ Est de grupu personarum magnarum qui est [comment]
...
## UnitType uniques（Forma Centuriae）
??? example  "Will not be displayed in Civilopedia"
	This unique is automatically hidden from users.
...
??? example  "Doing so will consume this opportunity to choose a Promotion"
	/ Hæc actio consumat hanc occasionem ad promotionem eligendam

	Applicable to: Promotion

??? example  "This Promotion is free"
	/ Hæc promotio est gratuita
...
??? example  "Grants [stats] to the first civilization to discover it"
	/ Donet [stats](m/s/um/os) civilizationi primæ quæ inveniat id
...
??? example  "Units ending their turn on this terrain take [amount] damage"
	/ Cum gressus perficitur, centuriæ accipiunt [amount] damnum si in hac humo sunt
...
??? example  "Grants [promotion] ([comment]) to adjacent [mapUnitFilter] units for the rest of the game"
	/ Donet [promotion] ([comment]), usque ad finem ludi, centuriis adjacentibus quæ sint [mapUnitFilter]
...
??? example  "[amount] Strength for cities built on this terrain"
	/ [amount] Potentiam urbibus ædificatis in hac humo
...
??? example  "Tile provides yield without assigned population"
	/ Tegula sine multitudine assignata præbet productum

	Applicable to: Terrain, Improvement

??? example  "Nullifies all other stats this tile provides"
	/ Dirimit alias statisticas quas hæc tegula præbet

	Applicable to: Terrain

??? example  "Only [improvementFilter] improvements may be built on this tile"
	/ Meliorationes non possunt in hac tegula ædificari nisi sint [improvementFilter]
...
??? example  "Blocks line-of-sight from tiles at same elevation"
	/ Claudit lineam conspectus ab tegula cum sublimitate æqua

	Applicable to: Terrain

??? example  "Has an elevation of [amount] for visibility calculations"
	/ Cum sublimitate, quæ est [amount], ad calculos visibilitatis
...
??? example  "[amount]% Chance to be destroyed by nukes"
	/ Armis atomicis diruatur cum probabilitate [amount]%
...
## Improvement uniques（Melioratio）
??? example  "[stats]"
	Example: "[+1 Gold, +2 Production]"
...
??? example  "Can also be built on tiles adjacent to fresh water"
	/ Etiam potest ædificari in tegulis adjacentibus ad aquam dulcem

	Applicable to: Improvement

??? example  "[stats] from [tileFilter] tiles"
	/ [stats] de tegulis quæ sunt [tileFilter]
...
??? example  "Ensures a minimum tile yield of [stats]"
	/ Promittit res producendas paucissimas esse [stats]
...
??? example  "Can be built outside your borders"
	/ Potest ædificari extra fines tuos

	Applicable to: Improvement

??? example  "Can be built just outside your borders"
	/ Potest ibi extra fines tuos ædificari, ubi ad eos (fines) adjaceat

	Applicable to: Improvement

??? example  "Can only be built on [tileFilter] tiles"
	/ Modo potest ædificari in tegulis quæ sunt [tileFilter]
...
??? example  "Cannot be built on [tileFilter] tiles"
	/ Non potest ædificari in tegulis quæ sunt [tileFilter]
...
??? example  "Can only be built to improve a resource"
	/ Modo potest ædificari ad meliorandam mercem
...
??? example  "Removes removable features when built"
	/ Cum ædificatur, summovet adjuncta quæ possint summoveri

	Applicable to: Improvement

??? example  "Gives a defensive bonus of [relativeAmount]%"
	/ Dat præmium defensionis quod est [relativeAmount]%
...
??? example  "Costs [amount] [stat] per turn when in your territory"
	/ Omni gressu consumat [amount] [stat](m/s/um/os) si in terra tua est
...
??? example  "Costs [amount] [stat] per turn"
	/ Omni gressu consumit [amount] [stat](m/s/um/os)
...
??? example  "Adjacent enemy units ending their turn take [amount] damage"
	/ Cum gressus perficitur, centuriæ hostiles adjacentes accipiunt [amount] damnum
...
??? example  "Provides a random bonus when entered"
	/ Passive (i.e. de cæcitate) præbet rem bonam si quis ingreditur
...
??? example  "Pillaging this improvement yields approximately [stats]"
	/ Direptio hujus tegulæ producat res quæ circiter sint [stats]
...
??? example  "Pillaging this improvement yields [stats]"
	/ Direptio hujus tegulæ producat res quæ sint [stats]
...
??? example  "Destroyed when pillaged"
	/ Consumatur quando diripitur

	Applicable to: Improvement

??? example  "Irremovable"
	/ Non potest summoveri

	Applicable to: Improvement

??? example  "Will not be replaced by automated units"
	/ Non substituetur centuriis automatariis

	Applicable to: Improvement

??? example  "Improves [resourceFilter] resource in this tile"
	/ Melioret mercem in hac tegula si [resourceFilter] sit
...
??? example  "Deposits in [tileFilter] tiles always provide [amount] resources"
	/ Depositiones in tegulas, quæ sunt [tileFilter], semper præbent [amount] merces
...
??? example  "Can only be created by Mercantile City-States"
	/ Modo potest creari civitatibus mercantibus urbium
...
??? example  "Guaranteed with Strategic Balance resource option"
	/ Promissa est cum optione de libra de strategemate
...
??? example  "Free [unit] found in the ruins"
	/ [unit] gratuitus/gratuita reperitur in parietinis
...
## Difficulty uniques（Difficultas）
!!! note ""
...
## CityState uniques（Civitas Urbis）
??? example  "Provides military units every ≈[positiveAmount] turns"
	/ Præbet centurias militares ≈[positiveAmount]-nis gressibus
...
??? example  "Provides a unique luxury"
	/ Præbet luxuriam unicam

	Applicable to: CityState

## ModOptions uniques（Optiones Mutationis）
...
??? example  "Allow City States to spawn with additional units"
	/ Licet civitatibus urbium cum centuriis addititiis exsistere
...
??? example  "Can only start games from the starting era"
	/ Modo potestis ludum ab ætate initiali incipere
...
??? example  "Allow raze holy city"
	/ Licet exscindere urbem sanctam
...
??? example  "Should only be used as permanent audiovisual mod"
	/ Modo in statu audivisifico sempiterno sit
...
??? example  "Can be used as permanent audiovisual mod"
	/ Potest ingredi statum audivisificum sempiternum
...
??? example  "Cannot be used as permanent audiovisual mod"
	/ Non potest ingredi statum audivisificum sempiternum
...
## EventChoice uniques（Electio Eventus）
??? example  "Only available"
	/ Parabilis modo est
...
??? example  "&lt;before turn number [nonNegativeAmount]&gt;"
	/ ante gressum [nonNegativeAmount]
...
??? example  "&lt;after turn number [nonNegativeAmount]&gt;"
	/ post gressum [nonNegativeAmount]
...
??? example  "&lt;when [victoryType] Victory is enabled&gt;"
	/ si victoria [victoryType] est habilitata
...
??? example  "&lt;when [victoryType] Victory is disabled&gt;"
	/ si victoria [victoryType] est debilitata
...
??? example  "&lt;with [nonNegativeAmount]% chance&gt;"
	/ cum probabilitate [nonNegativeAmount]%
...
??? example  "&lt;for [civFilter] Civilizations&gt;"
	/ civilizationibus quæ sunt [civFilter]
...
??? example  "&lt;during a Golden Age&gt;"
	/ intra sæculum aureum

	Applicable to: Conditional

??? example  "&lt;when not in a Golden Age&gt;"
	/ quom non in saeculo aureo

	Applicable to: Conditional

??? example  "&lt;during We Love The King Day&gt;"
	/ intra Festum de Amore Regis Nostri

	Applicable to: Conditional

??? example  "&lt;while the empire is happy&gt;"
	/ cum imperium est lætum
...
??? example  "&lt;if no other Civilization has researched this&gt;"
	/ si populi alii non invenerunt hanc

	Applicable to: Conditional

??? example  "&lt;after discovering [techFilter]&gt;"
	/ postquam invenis [techFilter](m/s/um/os)
...
??? example  "&lt;before discovering [techFilter]&gt;"
	/ antequam invenis [techFilter](m/s/um/os)
...
??? example  "&lt;while researching [techFilter]&gt;"
	/ si [techFilter](m/s/um/os) inveniens es
...
??? example  "&lt;if no other Civilization has adopted this&gt;"
	/ si populi alii non asciverunt hanc
...
??? example  "&lt;after adopting [policy/belief]&gt;"
	/ postquam asciscis [policy/belief](m/s/um/os)
...
??? example  "&lt;before adopting [policy/belief]&gt;"
	/ antequam asciscis [policy/belief](m/s/um/os)
...
??? example  "&lt;if [buildingFilter] is not constructed&gt;"
	/ si [buildingFilter] non est ædificatum
...
??? example  "&lt;if [buildingFilter] is constructed in all [cityFilter] cities&gt;"
	/ si [buildingFilter] est ædificatum in omnibus urbibus [cityFilter]
...
??? example  "&lt;if [buildingFilter] is constructed in at least [positiveAmount] of [cityFilter] cities&gt;"
	/ si [buildingFilter] est ædificatum in urbibus [cityFilter] non paucioribus quam [positiveAmount]
...
??? example  "&lt;if [buildingFilter] is constructed by anybody&gt;"
	/ si quis ædificavit [buildingFilter](m/s/um/os)
...
??? example  "&lt;if [buildingFilter] is not constructed by anybody&gt;"
	/ si nullus ædificavit [buildingFilter](m/s/um/os)
...
??? example  "&lt;when above [amount] [stat/resource]&gt;"
	/ si [stat/resource] sunt plures quam [amount]
...
??? example  "&lt;when below [amount] [stat/resource]&gt;"
	/ si [stat/resource] sunt pauciores quam [amount]
...
??? example  "&lt;in cities connected to the capital&gt;"
	/ in urbibus cum metropoli concatenatis

	Applicable to: Conditional

??? example  "&lt;in cities with a [religionFilter] religion&gt;"
	/ in urbibus cum una religione quæ est [religionFilter]
...
??? example  "&lt;in cities not following a [religionFilter] religion&gt;"
	/ in urbibus quæ non sequuntur ullam religionem quæ est [religionFilter]
...
??? example  "&lt;in cities with a major religion&gt;"
	/ in urbibus cum religione plera

	Applicable to: Conditional

??? example  "&lt;in cities with an enhanced religion&gt;"
	/ in urbibus cum religione amplificata

	Applicable to: Conditional

??? example  "&lt;in cities following our religion&gt;"
	/ in urbibus quæ sequuntur religionem nostram

	Applicable to: Conditional

??? example  "&lt;in cities with a [buildingFilter]&gt;"
	/ in urbibus cum [buildingFilter](o/is)
...
??? example  "&lt;in cities without a [buildingFilter]&gt;"
	/ in urbibus sine [buildingFilter](o/is)
...
??? example  "&lt;in cities with at least [positiveAmount] [populationFilter]&gt;"
	/ in urbibus cum [populationFilter](o/is) non paucioribus quam [positiveAmount]
...
??? example  "&lt;in cities with [positiveAmount] [populationFilter]&gt;"
	/ in urbibus cum [positiveAmount] [populationFilter](o/is)
...
??? example  "&lt;in cities with less than [amount] [populationFilter]&gt;"
	/ in urbibus cum [populationFilter](o/is) paucioribus quam [amount]
...
??? example  "&lt;for [mapUnitFilter] units&gt;"
	/ centuriis quæ sunt [mapUnitFilter]
...
??? example  "&lt;vs [mapUnitFilter] units&gt;"
	/ contra centurias quæ sunt [mapUnitFilter]
...
??? example  "&lt;when fighting units from a Civilization with more Cities than you&gt;"
	/ si pugna(n)t contra centurias de populo cum urbibus pluribus quam tuis
...
??? example  "&lt;when fighting in [tileFilter] tiles&gt;"
	/ si pugna(n)t in tegulis quæ sunt [tileFilter]
...
??? example  "&lt;on foreign continents&gt;"
	/ in continentibus alienis

	Applicable to: Conditional

??? example  "&lt;when adjacent to a [mapUnitFilter] unit&gt;"
	/ si adjacet ad centuriam quæ est [mapUnitFilter]
...
??? example  "&lt;when above [positiveAmount] HP&gt;"
	/ si sanitas sua est major quam [positiveAmount]
...
??? example  "&lt;when below [positiveAmount] HP&gt;"
	/ si sanitas sua est minor quam [positiveAmount]
...
??? example  "&lt;if it hasn't used other actions yet&gt;"
	/ si non egerit quid aliud

	Applicable to: Conditional

??? example  "&lt;when stacked with a [mapUnitFilter] unit&gt;"
	/ si est cumulata cum centuria quæ est [mapUnitFilter]
...
??? example  "&lt;in [tileFilter] tiles&gt;"
	/ in tegulis quæ sunt [tileFilter]
...
??? example  "&lt;in tiles without [tileFilter]&gt;"
	/ in tegulis sine [tileFilter](o/is)
...
??? example  "&lt;within [positiveAmount] tiles of a [tileFilter]&gt;"
	/ si abest a tegula, quæ est [tileFilter], non pluribus quam [positiveAmount] tegulis
...
??? example  "&lt;in tiles adjacent to [tileFilter] tiles&gt;"
	/ in tegulis adjacentibus ad tegulas quæ sunt [tileFilter]
...
??? example  "&lt;in tiles not adjacent to [tileFilter] tiles&gt;"
	/ in tegulis non adjacentibus ad tegulas quæ sunt [tileFilter]
...
??? example  "&lt;in all except [regionType] Regions&gt;"
	/ in omnibus regionibus nisi [regionType]
...
??? example  "&lt;if [modFilter] is not enabled&gt;"
	/ si [modFilter] non est habilitata

	Example: "&lt;if [DeCiv Redux] is not enabled&gt;"

	Applicable to: Conditional

## TriggerCondition uniques（Condicio Vegetans）
!!! note ""
...
??? example  "&lt;upon discovering [techFilter] technology&gt;"
	/ quando invenis technologiam quæ sit [techFilter]
...
??? example  "&lt;upon entering a new era&gt;"
	/ quandocumque ingrederis ætatem novam

	Applicable to: TriggerCondition

??? example  "&lt;upon adopting [policy/belief]&gt;"
	/ quando asciscis [policy/belief](m/s/um/os)
...
??? example  "&lt;upon discovering a Natural Wonder&gt;"
	/ quandocumque invenis miraculum naturale

	Applicable to: TriggerCondition

??? example  "&lt;upon constructing [buildingFilter]&gt;"
	/ quandocumque ædificas [buildingFilter](m/s/um/os)
...
??? example  "&lt;upon constructing [buildingFilter] [cityFilter]&gt;"
	/ quandocumque ædificas [buildingFilter](m/s/um/os) [cityFilter]
...
??? example  "&lt;upon gaining a [baseUnitFilter] unit&gt;"
	/ quandocumque acquiras centuriam quæ sit [baseUnitFilter]
...
??? example  "&lt;upon turn end&gt;"
	/ quandocumque gressus perficitur

	Applicable to: TriggerCondition, UnitTriggerCondition

??? example  "&lt;upon turn start&gt;"
	/ quandocumque gressus incipit

	Applicable to: TriggerCondition, UnitTriggerCondition

??? example  "&lt;upon founding a Pantheon&gt;"
	/ quando fundas Pantheum

	Applicable to: TriggerCondition

??? example  "&lt;upon founding a Religion&gt;"
	/ quando fundas religionem

	Applicable to: TriggerCondition

??? example  "&lt;upon enhancing a Religion&gt;"
	/ quando amplificas religionem

	Applicable to: TriggerCondition

??? example  "&lt;upon expending a [mapUnitFilter] unit&gt;"
	/ quandocumque exhauris centuriam quæ est [mapUnitFilter]

	Example: "&lt;upon expending a [Wounded] unit&gt;"

	Applicable to: TriggerCondition

## UnitTriggerCondition uniques（Condicio Vegetans de Centuria）
!!! note ""
...
??? example  "&lt;upon damaging a [mapUnitFilter] unit&gt;"
	/ quandocumque dat damnum centuriæ quæ est [mapUnitFilter]
...
??? example  "&lt;upon defeating a [mapUnitFilter] unit&gt;"
	/ quandocumque vincit contra centuriam quæ est [mapUnitFilter]
...
??? example  "&lt;upon being promoted&gt;"
	/ quandocumque promovetur

	Applicable to: UnitTriggerCondition

??? example  "&lt;upon gaining the [promotion] promotion&gt;"
	/ quando meret promotionem quæ est [promotion]
...
??? example  "&lt;upon losing the [promotion] promotion&gt;"
	/ quando amittit promotionem quæ est [promotion]
...
??? example  "&lt;upon gaining the [promotion] status&gt;"
	/ quando accipit statum qui sit [promotion]
...
??? example  "&lt;upon losing the [promotion] status&gt;"
	/ quando amittit statum qui sit [promotion]
...
??? example  "&lt;upon losing at least [positiveAmount] HP in a single attack&gt;"
	/ quandocumque in una oppugnatione amittit sanitatem non pauciorem quam [positiveAmount]
...
??? example  "&lt;upon ending a turn in a [tileFilter] tile&gt;"
	/ quandocumque gressus perficitur si est in tegula quæ est [tileFilter]
...
??? example  "&lt;upon discovering a [tileFilter] tile&gt;"
	/ quandocumque invenias tegulam quæ sit [tileFilter]
...
??? example  "&lt;upon entering a [tileFilter] tile&gt;"
	/ quandocumque init in tegulam quæ est [tileFilter]

	Example: "&lt;upon entering a [Farm] tile&gt;"

	Applicable to: UnitTriggerCondition

## UnitActionModifier uniques（Adiectio Actionis Centuriae）
!!! note ""

    Modifiers that can be added to UnitAction uniques as conditionals

??? example  "&lt;by consuming this unit&gt;"
	/ per consumptionem hujus centuriæ
...
??? example  "&lt;for all movement&gt;"
	/ per consumptionem omnis momenti
...
??? example  "&lt;requires [nonNegativeAmount] movement&gt;"
	/ requirat [nonNegativeAmount] momentum
...
??? example  "&lt;removing the [promotion] promotion/status&gt;"
	/ emoveat statum qui, sive promotionem quæ, est [promotion]
...
??? example  "&lt;[nonNegativeAmount] additional time(s)&gt;"
	/ totiens quam [nonNegativeAmount] pluribus quam possit
...
??? example  "&lt;after which this unit is consumed&gt;"
	/ postea hæc centuria sit consumpta
...
## MetaModifier uniques（Adiectio Adiectionis）
!!! note ""
...
??? example  "&lt;for [nonNegativeAmount] turns&gt;"
	/ in [nonNegativeAmount] gressibus dehinc
...
??? example  "&lt;for every adjacent [tileFilter]&gt;"
	/ ob omnem tegulam adjacentem quæ est [tileFilter]
...
??? example  "&lt;for every [positiveAmount] [countable]&gt;"
	/ ob [positiveAmount]-nos/na(s) [countable]
