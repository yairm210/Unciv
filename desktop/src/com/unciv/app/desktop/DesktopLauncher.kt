...
internal object DesktopLauncher {
    ...
    fun main(args: Array<String>) {
        // a developer who's certain all the atlas and game*.png files are up to date
        // can set this in the properties of his Desktop configuration to save time
        if (args.size == 0 || args[0] != "-nopack")
            packImages()
