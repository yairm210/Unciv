...
//             var curated = false
    ...
    // U+203e - chosen intentionally to be unusual but visible, so mad modders take notice
    // (U+2003 em-space would actually work for Windows NTFS - also decided against putting back the Minus sign, to avoid confusion)
