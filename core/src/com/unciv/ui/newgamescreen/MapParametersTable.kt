...
class MapParametersTable(
    ...
    private fun addMapShapeSelectBox() {
        ...
        if (mapParameters.type === MapType.randomGenerated) {
            ...
            val optionsTable = MultiCheckboxTable("{Map Shapes}:", "NewGameMapShapes", mapShapesOptionsValues, false) {
    ...
    private fun addMapTypeSelectBox() {
        ...
        if (mapParameters.type === MapType.randomGenerated) {
            ...
            val optionsTable = MultiCheckboxTable("{Map Generation Types}:", "NewGameMapGenerationTypes", mapTypesOptionsValues, false) {
    ...
    private fun addWorldSizeTable() {
        if (mapParameters.type === MapType.randomGenerated) {
            ...
            val optionsTable = MultiCheckboxTable("{World Sizes}:", "NewGameWorldSizes", mapSizesOptionsValues, false) {
    ...
    private fun addResourceSelectBox() {
        ...
        if (mapParameters.type === MapType.randomGenerated) {
            ...
            val optionsTable = MultiCheckboxTable("{Resource Settings}:", "NewGameResourceSettings", mapResourcesOptionsValues, false) {
