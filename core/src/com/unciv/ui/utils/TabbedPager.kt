 ...
 * 
 * @param minimumWidth Minimum width of shown content area.
 * @param maximumWidth Maximum width to grow with content to.
 * @param minimumHeight Minimum height of shown content area.
 * @param maximumHeight Maximum height to grow content area to.
