...
/**
 *  Manages keyboard panning of map holders.
 *
 *  @param mapHolder WorldScreen's or MapEditorScreen's mapHolder
 *  @param allowWASD Allow W,A,S,D keys too (the Arrows are always used)
 */
