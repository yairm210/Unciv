...
class CityConstructionsView(internal val cityConstructions: CityConstructions) {
    ...
    @Readonly fun getTurnsToConstructionString(construction: IConstruction, isFirst: Boolean): String = cityConstructions.getTurnsToConstructionString(construction, isFirst)
