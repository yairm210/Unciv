...
class City : IsPartOfGameInfoSerialization, INamed {
    ...
    @Readonly fun getResourcesGeneratedByCity(civResourceModifiers: Map<String, Float> = getResourceModifiers()) = CityResources.getResourcesGeneratedByCity(this, civResourceModifiers)
