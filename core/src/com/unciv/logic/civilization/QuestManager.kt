...
class AssignedQuest(val questName: String = "",
    ...
    fun getDescription(): String {
        ...
        val description = quest.description.fillPlaceholders(data1)
        if (quest.isGlobal() && quest.duration > 0) {
            // Only for timed global contests
            //TODO: description about who is first?
        }
        return description
    }
