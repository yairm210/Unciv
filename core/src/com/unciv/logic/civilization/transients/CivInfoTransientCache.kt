...
class CivInfoTransientCache(val civInfo: Civilization) {
    ...
    private fun setNewViewableTiles() {
        ...
        for (otherCiv in civInfo.getKnownCivs()) {
            if (otherCiv.allyCivName == civInfo.civName || otherCiv.civName == civInfo.allyCivName) {
    ...
    fun updateCivResources() {
        ...
        if (!civInfo.isCityState) {
            ...
            for (cityStateAlly in civInfo.getKnownCivs().filter { it.allyCivName == civInfo.civName }) {
