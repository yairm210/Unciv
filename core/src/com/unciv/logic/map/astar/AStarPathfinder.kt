...
internal class AStarPathfinder(
    ...
    private val passThroughPredicate: PathingMap.Companion.TilePredicate,
    private val moveToPredicate: PathingMap.Companion.TilePredicate,
    private val endTurnDamage: PathingMap.Companion.EndTurnDamageLookup,
    private val cost: PathingMap.Companion.TileMovementCost,
    private val tileRoadCost: PathingMap.Companion.TileRoadCost,
    private val relationshipLevel: (Tile) -> RelationshipLevel,
    private val endSearchPredicate: PathingMap.Companion.EndSearchPredicate,
    ...
    private fun neighborNeedsQueueing(currentNode: RouteNode, neighborTile: Tile): Boolean {
        ...
        return todoWithDamage > currentNode.damagingTiles
        //if (VERBOSE_PATHFINDING_LOGS == startingPoint || VERBOSE_PATHFINDING_LOGS == ALWAYS_LOG)
        ...
        // another tile already queued a route to that neighbor. skip it.
    }
