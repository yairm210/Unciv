...
open class TileInfo {
    ...
    fun getTileStats(city: CityInfo?, observingCiv: CivilizationInfo?): Stats {
        ...
        if (naturalWonder != null) {
            ...
            if (city != null && city.civInfo.hasUnique(UniqueType.DoubleNaturalWonderYields)) {
        ...
        if (city != null) {
            ...
            for (unique in tileUniques) {
                ...
                if (tileType == "Natural Wonder" && naturalWonder != null && city.civInfo.hasUnique(UniqueType.DoubleNaturalWonderYields)) {
                    stats.add(unique.stats)
                }
            }
