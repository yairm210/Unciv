...
@Pure fun Float.toFixedPointMove() = FixedPointMovement.fpmFromMovement(this)
@Pure operator fun Int.minus(other: FixedPointMovement) = FixedPointMovement.fpmFromMovement(this) - other
