...
class ConstructionAutomation(val cityConstructions: CityConstructions) {
    ...
    private fun getOnetimeUniqueBonuses(building: Building): Float {
        ...
        if (building.isWonder) {
            ...
            building.hasUnique(UniqueType.StatPercentFromObjectToResource) -> 2f // Should be weighed by the amount of active improvementFilter/buildingFilter in the city
            else -> 0f
        }
        return value
    }
