...
enum class UniqueType(
    ...
    @Deprecated("As of 4.17.4", ReplaceWith("May [Paradrop] to [Land] tiles up to [positiveAmount] tiles away <in [{Friendly} {Land}] tiles>"), DeprecationLevel.WARNING)
    MayParadropOld2("May Paradrop to [tileFilter] tiles up to [positiveAmount] tiles away", UniqueTarget.Unit),
    MayParadrop("May [comment] to [tileFilter] tiles up to [positiveAmount] tiles away", UniqueTarget.Unit),
