...
enum class UniqueType(
    ...
    TriggerUponDeclaringWarFiltered("upon declaring war with a [civFilter] Civilization", UniqueTarget.TriggerCondition),
    TriggerUponBeingDeclaredWarUpon("upon being declared war upon [civFilter] Civilization", UniqueTarget.TriggerCondition),
    TriggerUponEnteringWar("upon entering a war with [civFilter] Civilization", UniqueTarget.TriggerCondition),
