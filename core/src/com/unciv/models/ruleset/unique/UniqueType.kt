...
enum class UniqueType(
    ...
    OneTimeGainStat("Gain [countable] [civWideStat]", UniqueTarget.Triggerable, flags = setOf(UniqueFlag.AcceptsSpeedModifier),
        docDescription = "Amount accepts [countables](Countables), including expressions. Integers still work."),
    ...
    TriggerUponPromotion("upon being promoted", UniqueTarget.UnitTriggerCondition, UniqueTarget.TriggerCondition),
    TriggerUponPromotionGain("upon gaining the [promotion] promotion", UniqueTarget.UnitTriggerCondition, UniqueTarget.TriggerCondition),
    TriggerUponPromotionLoss("upon losing the [promotion] promotion", UniqueTarget.UnitTriggerCondition, UniqueTarget.TriggerCondition),
