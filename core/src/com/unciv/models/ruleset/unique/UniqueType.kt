...
enum class UniqueType(
    ...
    ReducedTechSteal(
        "Enemy spies steal [relativeAmount]% of a technology in [cityFilter]",
        UniqueTarget.Global
    ),
    ...
    ConditionalWhenCounterIntelligence("when counter-intelligence is active", UniqueTarget.Conditional),
