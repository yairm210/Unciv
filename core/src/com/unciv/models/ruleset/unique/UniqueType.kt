...
enum class UniqueType(
    ...
    TriggerUponBeingDeclaredWarUpon("upon being declared war upon", UniqueTarget.TriggerCondition),
    TriggerUponEnteringWar("upon entering a war", UniqueTarget.TriggerCondition),
