...
enum class UniqueParameterType(
    ...
    /** User by [UniqueType.OneTimeUnitGiveRuinReward] */
    RuinReward("ruinReward", "a stash of gold", "The name of an entry in Ruins.json") {
        override fun getKnownValuesForAutocomplete(ruleset: Ruleset) = ruleset.ruinRewards.keys
    },
