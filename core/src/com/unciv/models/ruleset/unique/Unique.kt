...
class Unique(val text: String, val sourceObjectType: UniqueTarget? = null, val sourceObjectName: String? = null) {
    ...
    private fun conditionalApplies(
        ...
        return when (condition.placeholderText) {
            ...
            UniqueType.ConditionalAttacking.placeholderText -> state.combatAction == CombatAction.Attack
            UniqueType.ConditionalDefending.placeholderText -> state.combatAction == CombatAction.Defend
            else -> false
        }
    }
