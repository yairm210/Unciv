...
class Translations : LinkedHashMap<String, TranslationEntry>(){
    ...
    companion object {
        ...
        const val englishConditionalOrderingString = 
            "<for [mapUnitFilter] units> <vs cities> <vs [mapUnitFilter] units> <for combat in [tileFilter] tiles> <when attacking> <when defending> <if this city has at least [amount] specialists> <when at war> <when not at war> <while the empire is happy> <during a Golden Age>"
