...
class BattleTest {
    ...
    fun `should give diplomacy penality for using a nuke`() {
        ...
        // then
        assertEquals(-90f, defenderCiv.getDiplomacyManager(attackerCiv).opinionOfOtherCiv()) // 50 for nuke, 20 for war declaration, 20 for warmongering
        assertEquals(-70f, thirdCiv.getDiplomacyManager(attackerCiv).opinionOfOtherCiv()) // 50 for nuke, 20 for warmongering
    }
